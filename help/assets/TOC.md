...
# AEM 6.4资产用户指南 {#assets}

+ [资产用户指南](home.md)
+ [AEM 6.4 Assets发行说明](https://docs.adobe.com/content/help/en/experience-manager-64/release-notes/assets.html)
+ [关于DAM](assets.md)
...
+ 管理资产 {#administer}
   ...
   + [将AEM Assets与InDesign Server集成](indesign.md)
