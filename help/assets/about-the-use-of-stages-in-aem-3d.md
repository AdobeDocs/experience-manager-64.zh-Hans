...
description: 舞台是轻量级3D场景文件，提供基本的查看环境。
seo-description: 舞台是轻量级3D场景文件，提供基本的查看环境。
...
>[!NOTE]
>
>**[!UICONTROL OBJ 3D格式不支持灯光]** 。 因此，它不能用于向 AEM 3D 提供舞台。
...
在上传到AEM之前，AEM 3D中除输出图像类型和大小外的所有渲染设置必须预先配置并保存到舞台文件中。