---
title: 管理 [!DNL Adobe Experience Manager Assets]中的 [!DNL Adobe Stock] 资产。
...
集成需要[企业Adobe Stock计划](https://stockenterprise.adobe.com/)和[!DNL Experience Manager] 6.4，并且至少部署了Service Pack 2。 有关[!DNL Experience Manager] 6.4 Service Pack的详细信息，请参阅以下[发行说明](/help/release-notes/sp-release-notes.md)。
...
1. 单击&#x200B;**[!UICONTROL 创建新项目]**，然后单击&#x200B;**[!UICONTROL 添加API]**。 从[!UICONTROL 可用于]的API列表中选择&#x200B;**[!UICONTROL Adobe Stock]**。 选择[!UICONTROL OAUTH 2.0 Web]。 配置并复制显示的各种值。
...
>[!NOTE]
>
>如果有多个[!DNL Adobe Stock]配置，请在“用户首选项”面板(**[!UICONTROL AEM]** > **[!UICONTROL 用户图标]** > **[!UICONTROL 用户首选项]** > **[!UICONTROL Stock配置]**)中选择所需的配置。
...
* 要在[!DNL Adobe Stock]和[!DNL Experience Manager Assets]中搜索资产，请单击search ![search_icon](assets/search_icon.png)。
