...
该集成需要[企业Adobe Stock计划](https://stockenterprise.adobe.com/)和[!DNL Experience Manager] 6.4，并且至少部署了Service Pack 2。 有关[!DNL Experience Manager] 6.4 Service Pack的详细信息，请参阅以下[发行说明](/help/release-notes/sp-release-notes.md)。
...
* 要在[!DNL Adobe Stock]和[!DNL Experience Manager Assets]中搜索资产，请单击搜索![search_icon](assets/search_icon.png)。
...
![用于在Adobe Stock资产中授权和保存Experience Manager资产的对话框](assets/aem-stock_licenseandsave.jpg)
