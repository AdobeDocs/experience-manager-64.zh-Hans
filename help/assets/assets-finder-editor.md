...
>[!NOTE]
>
>默认情况下，当您从数字资产管理器中的“新建 **** ”创建资产共享页面时，系统会自动为您创建资产查看器和资产编辑器。

要在网站控制台中创建新的资产共享页 **面，请** :

1. 在“网 **[!UICONTROL 站]** ”选项卡中，导航到要创建资产共享页面的位置，然后单击“新 **[!UICONTROL 建”]**。

1. 选择资 **[!UICONTROL 产共享]** 页面，然后 **[!UICONTROL 单击创建]**。 此时会创建新页面，并且资产共享页面会列在“网 **[!UICONTROL 站]** ”选项卡中。
...
要自定义资产共享页面，您可以使用Sidekick中的元素，还可以编辑查询生成器属性。 页面 **[!UICONTROL Geometrixx]** Press Center是基于此模板的自定义页面版本：

![screen_shot_2012-04-19at123048pm](assets/screen_shot_2012-04-19at123048pm.png)

要通过数字资产管理器创建新的资产共享页面，请执行以下操作：

1. 在数字资产管理器的新 **[!UICONTROL 增中]**，选择 **[!UICONTROL 新增资产共享]**。
1. 在标 **[!UICONTROL 题]**&#x200B;中，输入资产共享页面的名称。 如果需要，请输入URL的名称。
...
1. 多次-单击资产共享页面以将其打开并配置页面。
   ...
   默认情况下，当您从“新建”创建“资产共享 **[!UICONTROL ”页面]**&#x200B;时，系统会自动为您创建资产查看器和资产编辑器。
...
1. 在要自定义的资产共享页面中，单击 **[!UICONTROL Sidekick中]** 的操作。
...
| [!UICONTROL Lightbox 操作] | 将资产保存到“Lightbox”中，您可以在其中对其执行其他操作。 在跨多个页面处理资产时，此功能非常便于使用。 Lightbox还可用作资产的购物车。 |
...
1. 在要自定义的资产共享页面中，单击搜 **[!UICONTROL 索]**。
...
1. 在要自定义的“资产共享”页面中，单击 **[!UICONTROL 查询]** Builder中的编辑。 默认情况下，将打 **[!UICONTROL 开“]** General”（常规）选项卡。

1. 选择每页的结果数、资产编辑器的路径（如果您有自定义的资产编辑器）和操作标题。

   ![screen_shot_2012-04-23at15055pm](assets/screen_shot_2012-04-23at15055pm.png)

1. Click the **[!UICONTROL Paths]** tab. 输入要运行搜索的一个或多个路径。 如果用户使用“路径”谓词，则这些路径将被覆盖。

   ![screen_shot_2012-04-23at15150pm](assets/screen_shot_2012-04-23at15150pm.png)

1. 根据需要输入其他节点类型。

1. 在查询 **[!UICONTROL 生成器URL]** 字段中，可以覆盖或绕排查询生成器，并使用现有的查询生成器组件输入新的servlet URL。 在信 **[!UICONTROL 息源URL]** 字段中，您也可以覆盖信息源URL。

   ![screen_shot_2012-04-23at15313pm](assets/screen_shot_2012-04-23at15313pm.png)

1. 在“文 **[!UICONTROL 本]** ”字段中，输入要显示的结果文本和结果的页码。 完成 **[!UICONTROL 更改]** 后，单击“确定”。
...
有关详细信息，请参阅谓 [词javadocs](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/search/eval/package-summary.html)。
...
1. 在“网 **[!UICONTROL 站]** ”选项卡中，导航到要创建资产编辑器页面的位置，然后单击“新 **[!UICONTROL 建”]**。

1. 选择 **[!UICONTROL Geometrixx资产编辑]** ，然后单 **[!UICONTROL 击创建]**。 将创建新页面，并且该页面会列在“网 **[!UICONTROL 站]** ”选项卡。
...
要自定义资产编辑器页面，请使用Sidekick中的元素。 从Geometrixx出版中心访问的资产编辑 **[!UICONTROL 器页面]** ，是基于此模板的自定义页面版本：

![assetshare6](assets/assetshare6.bmp)

#### 设置从资产共享页面打开的资产编辑器 {#setting-which-asset-editor-opens-from-an-asset-share-page}

在创建自定义资产编辑器页面后，您需要确保在多次单击您创建的自定义资产共享的资产时，会在自定义编辑器页面中打开资产。

要设置“资产编辑器”页面，请执行以下操作：

1. 在“资产共享”页面中，单 **[!UICONTROL 击查询]** 构建器旁边的“编辑”。

   ![screen_shot_2012-04-23at20123pm](assets/screen_shot_2012-04-23at20123pm.png)

1. 如果尚 **[!UICONTROL 未选]** 定，请单击“常规”选项卡。

1. 在资产 **[!UICONTROL 编辑器的路径]** ，输入您希望资产共享页面在中打开资产的资产编辑器的路径，然后单击确 **[!UICONTROL 定]**。
...
1. 在要自定义的“资产编辑器”页面中，选择 **[!UICONTROL Sidekick中的]** “资产编辑器”。 将显示所有可用的资产编辑器组件。
...
元数据表单是包含开始和结束操作的表单。 在中间输入文 **[!UICONTROL 本]** 字段。 请参 [阅Forms](../sites-authoring/default-components.md) ，了解有关使用表单的更多信息。

1. 通过单击表单的开始区 **[!UICONTROL 域]** 中的编辑，创建开始操作。 如果需要，可以输入Box标题。 默认情况下，“框”标题为 **[!UICONTROL 元数据]**。 如果希望生成验证的java脚本客户端代码，请选中“客户端验证”复选框。

   ![screen_shot_2012-04-23at22911pm](assets/screen_shot_2012-04-23at22911pm.png)

1. 通过单击表单的“结束 **[!UICONTROL ”区]** 域中的“编辑”创建“结束”操作。 例如，您可能希望创建“提 **[!UICONTROL 交]** ”按钮，以允许用户提交其元数据更改。 或者，您可以添加将元 **[!UICONTROL 数据]** 重置为其原始状态的“重置”按钮。

   ![screen_shot_2012-04-23at23138pm](assets/screen_shot_2012-04-23at23138pm.png)

1. 在表单 **[!UICONTROL 开始]** 和表 **单结尾之**&#x200B;间，将元数据文本字段拖动到表单中。 用户将元数据填充到这些文本字段中，他们可以提交或完成其他操作。

1. 多次单击字段名称，例如 **标题** ，打开元数据字段并进行更改。 在“编 **[!UICONTROL 辑组]** 件 [!UICONTROL ”窗口的“常规] ”选项卡中，定义命名空间、字段标签以及类型，例如 `dc:title`。


   ![screen_shot_2012-04-23at23305pm](assets/screen_shot_2012-04-23at23305pm.png)

   有关 [修改元数据表单中可用的命名空间的信息](extending-assets.md) ，请参阅自定义和扩展AEM Assets。

1. Click the **[!UICONTROL Constraints]** tab. 您可以在此选择字段是否为必填字段，并根据需要添加任何约束。

   ![screen_shot_2012-04-23at23435pm](assets/screen_shot_2012-04-23at23435pm.png)

1. Click the **[!UICONTROL Display]** tab. 在此，您可以为元数据字段输入新的宽度和行数。 选中字 **段为只读复选框** ，允许用户编辑元数据。
...
子资产组件是您可以视图和选择子资产的位置。 您可以确定主资产和子资 [产下](assets.md#what-are-digital-assets) 显示的名称。
...
多次-单击标记组件以打开标记对话框，您可以根据需要从标记中更改标题，也可以选择已分配的命名空间。 要使此字段可编辑，请清除“隐 **藏编辑** ”按钮复选框。 默认情况下，标记是可编辑的。
...
缩略图组件是资产显示选定缩略图的位置（对于许多格式，缩略图会自动提取）。 此外，该组件还显示文件名以 [及您可以修改的操作](assets-finder-editor.md#adding-asset-editor-actions)。

![screen_shot_2012-04-23at25452pm](assets/screen_shot_2012-04-23at25452pm.png)

多次-单击缩略图组件以打开缩略图对话框，在该对话框中可以更改替代文本。 默认情况下，缩略图替代文本默认为 **[!UICONTROL 单击以下载资]** 产。
...
1. 在要自定义的“资产编辑器”页面中，单击 **[!UICONTROL Sidekick中的]** “资产编辑器”。<br>
...
## 使用“资产编辑器”页面编辑多个资产 {#multi-editing-assets-with-the-asset-editor-page}
...
1. 打开Geometrixx **[!UICONTROL 新闻中心]** (位于 `http://localhost:4502/content/geometrixx/en/company/press.html`)。
1. 选择资产：
...
1. 在“ **[!UICONTROL 操作]** ”字段( **页面左侧部分** )中单击“编辑元数据”。

1. Geometrixx按 **[!UICONTROL 下中心资产编辑器]** (Center Asset Editor)页面在新选项卡中打开。 资产的元数据会按如下方式显示：
...
1. 单击“标记”字段旁 **[!UICONTROL 边的]** “铅笔”图标以编辑标记：
   ...
   * 单击图 `x` 标可删除所有资产的标记。
   * 单击图 `+` 标以将标记添加到所有资产。
   * 单击标 `arrow` 记，然后选择一个标记以向所有资产添加新标记。

   单 **[!UICONTROL 击]** “确定”将更改写入表单。 “标记”字段旁 **边的框** 将自动被选中。
...
1. 单击 **[!UICONTROL 更新元数据]** ，以提交表单并保存所有资产的更改。 只修改选定的元数据。
