...
1. 访 [问https://console.adobe.io](https://console.adobe.io) ，并导航到“集成”页面上的现有智能 **[!UICONTROL 内容]** 服务。 上传新证书。 有关详细信息，请参阅创建Adobe开 [发人员控制台集成中的说明](#create-adobe-i-o-integration)。
