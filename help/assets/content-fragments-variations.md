...
[变](content-fragments.md#constituent-parts-of-a-content-fragment) 量是内容片段的重要功能，因为它们允许您创建和编辑主控内容的副本，以用于特定渠道和/或场景。
...
打开内容片段进行编辑时，默认情况下将打开&#x200B;**变量**&#x200B;选项卡。 您可以在此创作内容，以用于主控或您拥有的任何变体。 您可以：
...
* [总结文本](#summarizing-text)
* [批注](content-fragments-variations.md#annotating-a-content-fragment) 您的文本
...
>[!NOTE]
>
>有关完整信息，请参阅[标记](content-fragments-markdown.md)文档。
...
* 通过在片段编辑器中选择&#x200B;**[!UICONTROL 注释]**&#x200B;选项卡，可以列出和删除。

   ![cfm-6420-25](assets/cfm-6420-25.png)

* 可在选定片段的[时间轴](https://helpx.adobe.com/experience-manager/6-3/assets/using/content-fragments-managing.html#timeline-for-content-fragments)中查看和删除。

### 将资产插入片段{#inserting-assets-into-your-fragment}

要简化创作内容片段的过程，您可以直接将[资产](managing-assets-touch-ui.md)（图像）添加到片段。
...
>[!NOTE]
>
>有多种方法可将[images](content-fragments.md#fragments-with-visual-assets)添加到片段和/或页面。
...
1. 打开片段，从侧面板中选择&#x200B;**[!UICONTROL 变量]**。
1. 选择所需的变量。
1. 从&#x200B;**[!UICONTROL 操作]**&#x200B;下拉列表中选择&#x200B;**[!UICONTROL 删除]**。
