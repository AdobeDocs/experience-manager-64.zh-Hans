...
对于过期的资产，卡上的标记会指示该资产已过期。

![expired_flag_card](assets/expired_flag_card.png)

**列表视图**

对于过期的资产，状 **[!UICONTROL 态列显]** 示“已 **[!UICONTROL 过期]** ”横幅。
...
1. 在“资产”控制台中，单击工 **具栏中** 的“搜索”图标以显示“全源搜索”框。

   ![chlimage_1-149](assets/chlimage_1-149.png)

1. 当光标位于Omni Search框中时，点击Return键可显示“搜索结果”页面。
...
当您选择“已过 **期** ”选项时，“资产”控制台仅显示复合资产引用的已过期资产和子资产。 引用已过期子资产的复合资产在子资产过期后不会立即显示。 而是在AEM资产检测到它们在下次运行计划程序时引用过期的子资产后显示它们。
...
1. 要根据资产的状态搜索资产，请单击／点按搜 **[!UICONTROL 索图标]** ，以显示Omni Search栏。

   ![chlimage_1-162](assets/chlimage_1-162.png)

1. 按回车键，然后单击／点按 **[!UICONTROL GlobalNav]** 图标以显示“搜索”面板。
...
>[!NOTE]
>
>已弃 *用用于在AEM的早期版本中存储许可证的位置* /etc/dam/drm/licenses。
>
>如果您创建或修改许可证页面，或从先前的AEM版本中移植它们，Adobe建议您将它们存储在 */apps/settings/dam/drm/licenses* 或 */conf/&amp;ast;/settings/dam/drm/licenses下*。
