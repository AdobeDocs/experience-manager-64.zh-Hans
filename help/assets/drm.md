---
title: Digital Rights Management位于 [!DNL Adobe Experience Manager Assets]。
...
1. 从菜单中选择&#x200B;**[!UICONTROL 引用]**。
   ...
   对于已过期的资产，引用边栏的顶部会显示到期状态&#x200B;**[!UICONTROL 资产已过期]**。

   ![chlimage_1-147](assets/chlimage_1-147.png)

   如果资产已过期子资产，引用边栏会显示状态&#x200B;**[!UICONTROL 资产已过期子资产]**。
...
1. 将光标置于Omnisearch框中，按Enter键可显示搜索结果页面。
...
1. 单击&#x200B;**[!UICONTROL Expiry Status]**&#x200B;选项以展开它。
...
1. 在高级选项卡中，从&#x200B;**[!UICONTROL 过期]**&#x200B;字段中设置资产的过期日期。
