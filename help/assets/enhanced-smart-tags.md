...
>[!NOTE]
>
>如果您使用的是AEM 6.3或更早版本，并且需要为资产自动添加标签服务，请参阅智 [能标签](https://helpx.adobe.com/experience-manager/6-3/assets/using/touch-ui-smart-tags.html)。 智能标记不使用AI功能，并且不如增强的智能标记功能准确。
...
1. 要下载报告，请从列表中选择它，然后点按／单击工具栏中 **[!UICONTROL 的]** “下载”图标。 报告以Excel文件的形式下载。
...
1. 点按／单击底部的箭头，然后点按／单击“开始工 **[!UICONTROL 作流”]**。
