---
title: 文件夹元数据架构
description: 本文介绍了如何在中为资产文件夹创建元数据架构 [!DNL Experience Manager] 资产
...
本文介绍了如何在中为资产文件夹创建元数据架构 [!DNL Experience Manager] 资产。

Adobe Experience Manager Assets允许您为资产文件夹创建元数据架构，该架构可定义文件夹属性页面中显示的布局和元数据。

>[!NOTE]
>
>此功能需要 [!DNL Experience Manager] 6.4并至少部署了Service Pack 2。 对于 [!DNL Experience Manager] 6.4 service pack详细信息，请参阅这些 [发行说明](/help/release-notes/sp-release-notes.md).
...
要编辑表单项的属性，请点按/单击组件，然后在 **[!UICONTROL 设置]** 选项卡。
...
1. 从 [!DNL Assets] 用户界面，点按/单击 **[!UICONTROL 创建]** 中。
1. 指定文件夹的标题和名称。
