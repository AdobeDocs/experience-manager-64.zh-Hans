---
title: 文件夹元数据架构
description: 本文介绍如何为AEM资产中的资产文件夹创建元数据架构
...
本文介绍如何为AEM资产中的资产文件夹创建元数据架构。

Adobe Experience Manager(AEM)资产允许您为资产文件夹创建元数据架构，这可定义在文件夹属性页面中显示的布局和元数据。

>[!NOTE]
>
>此功能要求AEM 6.4至少部署了Service Pack 2。 有关AEM 6.4 Service Pack的详细信息，请参阅这些 [发行说明](/help/release-notes/sp-release-notes.md)。
...
1. 在“文件夹元数据架构编辑器”页面中，点按／单 **[!UICONTROL 击+图]** 标，向表单中添加选项卡。 要重命名选项卡，请点按／单击默认名称，然后在“设置”下指定新 **[!UICONTROL 名称]**。

   ![custom_tab](assets/custom_tab.png)

   要添加更多选项卡，请点按／单 **[!UICONTROL 击+图]** 标。 Tap/click **[!UICONTROL X]** to delete a tab.
