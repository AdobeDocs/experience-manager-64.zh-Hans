...
热链接是指第三方网站使用HTML代码显示您网站中的图像时。 他们每次请求图片时都会使用您的带宽，因为访客的浏览器直接从您的服务器访问它。 热链 *接保护* 是一种方法，可防止其他网站直接链接到您网页上的图片、css或javascript。 这种保护罩有助于减少Dynamic Media帐户下不必要的带宽使用。

[Adobe支持](https://helpx.adobe.com/support.html) 可以在CDN级别配置推荐人过滤器，以便Dynamic Media内容仅提供给您列表的域授权网站上的网站。
