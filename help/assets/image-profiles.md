...
在向现有图像用户档案添加智能裁剪时，如果要为资产存储库中的现有资产生成裁剪， [则需要重新触发](assets-workflow.md) DAM更新资产工作流。
...
1. 执行下列操作之一：
   ...
   * 导航到 **https://&lt;AEM服务器>/mnt/overlay/dam/gui/content/assets/foldersharewizard.html/content/dam** ，应用相应的用户档案并点按 **保存**。
