...
description: 创建包含USM锐化和智能裁切、智能色板或智能色板设置的图像配置文件，或同时创建这两个设置的图像配置文件，然后将配置文件应用到图像资产的文件夹。
seo-description: 创建包含USM锐化和智能裁切、智能色板或智能色板设置的图像配置文件，或同时创建这两个设置的图像配置文件，然后将配置文件应用到图像资产的文件夹。
...
1. 执行下列操作之一：
   ...
   * 导航到 **https://&lt;AEM服务器>/mnt/overlay/dam/gui/content/assets/foldersharewizard.html/content/dam** ，应用相应的配置文件并点按保 **存**。
