...
1. From the Search Forms page, select **[!UICONTROL Assets Admin Search Rail]**, then tap  **Edit** ![aemassets_edit](assets/aemassets_edit.png).
   ...
   > 
   >1. 导航 *到CRX-DE中的/conf/global/settings/dam/search/facets/assets/jcr:content/items* 。
   >1. 删除 **类型节** 点。
...
1. 执行下列操作之一：
   ...
   * 点 ![按“选项](assets/do-not-localize/aem_assets_add_icon.png) ”字段旁边的添加图标，以指定要在“滤镜”面板中提供的选项的显示文本和值。 要添加其他选项，请点按／单 ![击添加图标](assets/do-not-localize/aem_assets_add_icon.png) ，然后重复该步骤。
...
1. 在“搜索表单”页面上，选择“ **[!UICONTROL 资产管理员搜索边栏]**”，然后点 **按** Edit ![](assets/aemassets_edit.png)aemassets_edit。
...
1. 点按工 **[!UICONTROL 具栏中]**![的删](assets/deleteoutline.png) 除删除大纲。
...
| [!UICONTROL 预览] | 在CRX中的/var/dam/content节点上具有读取、写入和删除权限。 此外，对/apps节点具有“读写”权限。 |
