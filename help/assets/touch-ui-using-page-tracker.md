...
description: 了解如何在网站代码中包含页面跟踪器和嵌入JavaScript代码，使Adobe Analytics能够捕获围绕资源的使用数据。
contentOwner: AG
...
页面跟踪器是一段JavaScript代码，包含在第三方网站的代码中，使Adobe Analytics能够在这些网站上捕获围绕Adobe Experience Manager(AEM)资源的使用数据。
