...
1. 通过执行以下操作，**上传 Dynamic Media 视频**：
   ...
   * 将主视频上传到文件夹。您可以上传每个最大15 GB的视频文件。 将视频添加到文件夹后，这些视频会根据您分配给文件夹的视频处理配置文件进行编码。
...
1. 点按AEM左上角的AEM徽标，然后点按左边栏中的&#x200B;**[!UICONTROL 工具> Assets]**。
...
1. 点按AEM左上角的AEM徽标，然后点按左边栏中的&#x200B;**[!UICONTROL 工具>资产>视频报表]**。
