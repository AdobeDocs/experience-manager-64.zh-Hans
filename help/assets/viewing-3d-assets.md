...
1. 执行以下操作之一：
   ...
   * 在资产详细信息页面的右上角附近，点按&#x200B;**[!UICONTROL 相机选择器]**&#x200B;图标，然后选择要应用于3D资产的相机视图。
...
## 在站点3D组件{#viewing-d-assets-in-the-sites-d-component}中查看3D资产
...
1. 使用两指拖动来平移相机。 此操作可横向移动相机，使您在放大时查看对象的不同部分。 或者，点按&#x200B;**[!UICONTROL 绕行／平移切换]**&#x200B;按钮以切换至平移模式，然后使用一指拖动来平移相机。 点按&#x200B;**[!UICONTROL 绕行／平移切换]**&#x200B;按钮可还原到&#x200B;**[!UICONTROL 绕行]**&#x200B;模式。
