...
| 功能 | 描述 | [!DNL Workfront] 和 [!DNL Assets Essentials] | [!DNL Workfront for Experience Manager enhanced connector] |
|----|----|----|-----|
...
| 在Workfront中自动创建链接的AEM文件夹 | 使用对象状态在Workfront中自动创建链接的AEM文件夹。 根据WorkfrontPortfolio、项目和项目自动组织AEM文件夹。 | 否 | ✓ |
...
| 在Workfront中自动创建文档自定义Forms | 使用AEM工作流将自定义表单附加到Workfront文档、任务和问题。 | 否 | ✓ |
...
| AEM元数据更新了新版本 | 可以在AEM中进行配置，以确定Workfront中新版本化的资产是否还会推送对其元数据所做的任何更改。 | 否 | ✓ |
...
| 在Workfront对象上设置状态 | 使用AEM工作流设置基于Workfront对象状态的可配置条件 | 否 | ✓ |
| 将资产发布到AEM发布环境或Brand Portal | 为Workfront用户提供相应选项，以将链接的资产自动发布到AEM发布环境或Brand Portal。 | 否 | ✓ |
