...
+ AEM Communities简介{#introduction}
   ...
   + [创作新社区站点以启用](enablement-create-site.md)
...
+ 开发 {#develop}
   ...
   + [SCF Handlebers](handlebars-helpers.md)
   + [存储资源提供程序概述](srp.md)
   + [社区站点基础](sites-for-developers.md)
   + [活动 Stream Essentials](essentials-activities.md)
   + [任务基础](essentials-assignments.md)
   + [Blog Essentials](blog-developer-basics.md)
   + [日历基础](calendar-basics-for-developers.md)
...
+ 创作 {#authoring}
   ...
   + [使用投票](voting.md)
   + [创建示例页面](https://experienceleague.adobe.com/docs/experience-manager-64/communities/develop/create-sample-page.html)
