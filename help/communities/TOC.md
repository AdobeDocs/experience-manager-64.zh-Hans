...
# AEM 6.4 Communities用户指南 {#communities}

+ [Communities用户指南概述](home.md)
+ Introduction to AEM Communities {#introduction}
   ...
   + [体验已发布的启用站点](enablement-published-site.md)
+ 部署 {#deploy}
...
+ 开发 {#develop}
   ...
   + [OSGi Events for Communities组件](events.md)
   ...
   + [Votting Essentials](essentials-voting.md)
   ...
   + [向示例页面添加评论](extend-sample-page.md)
