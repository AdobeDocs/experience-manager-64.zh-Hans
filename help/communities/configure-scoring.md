...
当所选SRP是JSRP或MSRP，但不是ASRP时，可以视图与评分和徽章相关的UGC。 (如果不熟悉这些术语，请参阅[社区内容存储](working-with-srp.md)和[存储资源提供者概述](srp.md)。)
...
已安装的[版本](deploy-communities.md#LatestReleases)的最新Javadoc可从Adobe库向开发人员提供。 请参阅[使用Maven for Communities:Javadocs](maven.md#javadocs)。
...
1. 具有唯一id的AEM站点（使用向导创建的社区站点）:
   ...
   * 使用在[入门教程](getting-started.md)中创建的入门教程（参与）站点
   * 找到论坛页面节点
...
* [用于](functions.md#leaderboard-function) 包含在社区站点或组模板中的排行榜功能。
