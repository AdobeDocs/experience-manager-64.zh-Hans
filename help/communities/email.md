...
OSGi配置和 `AEM Communities Email Reply Configuration` 名称电子邮件的实例用于通知功能。 此功能不包括电子邮件回复。
...
* **[!UICONTROL URL]**:(必 *需)* “出站邮件服务器”。 例如，`pop.gmail.com:995/INBOX?username=community-emailgmail.com&password=****`
