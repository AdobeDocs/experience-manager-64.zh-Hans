...
当选 `ENABLEMENT`定的社区站点模板包含分配功能时，这些 [设置将适用](functions.md#assignments-function)，启用功能获得许可并配 [置时](enablement.md)。 包含分配功能的参考站点模板是 `Reference Structured Learning Site Template.`
