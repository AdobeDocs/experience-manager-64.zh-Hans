...
在发布环境中注册的用户通常称为 *社区成员（成员）* ，以便在创作环境中将其与*用户*区分开。
...
* 有关详细信息，请参阅 [配置说明](deploy-communities.md#tunnel-service-on-author) 部署页面上的
...
在发布环境中，具体取决于 [设置](sites-console.md#user-management) 在社区站点中，站点访客可能成为社区成员
...
2. 定位和拖动 `community-enablementmanagers` 到 **[!UICONTROL 群组]** 右窗格中显示的新用户的选项卡
