...
+ 快速入门 {#getting-started}
   ...
   + AEM Forms参考资料 {#aem-forms-reference-collaterals}
      + [设置和配置AEM Forms引用站点](using/setup-reference-sites.md)
      + [We.Finance参考站点演练](using/finance-reference-site-walkthrough.md)
      + [We.Gov引用站点演练](using/gov-reference-site-walkthrough.md)
      ...
      + [We.金融车险续订参考网站](/help/forms/using/finance-auto-insurance-renewal-reference-site-walkthrough.md)
...
+ 安装和配置AEM Forms {#install-aem-forms}
   ...
   + 在OSGi上安装AEM Forms {#osgi-installation}
      + [OSGi上AEM表单的支持平台](https://helpx.adobe.com/cn/experience-manager/6-4/sites/deploying/using/technical-requirements.html)
   ...
   + 在JEE上安装AEM Forms {#jee-installation}
      ...
      + [准备安装AEM Forms（单服务器）](http://www.adobe.com/go/learn_aemforms_prepareInstallsingle_64)
      + [在JEE上安装和部署Adobe Experience Manager Forms for JBoss](http://www.adobe.com/go/learn_aemforms_installJBoss_64_cn)
      + [在JEE上安装和部署AEM Forms for WebLogic](http://www.adobe.com/go/learn_aemforms_installWebLogic_64_cn)
      + [在JEE for WebSphere上安装和部署Adobe Experience Manager Forms](http://www.adobe.com/go/learn_aemforms_installWebSphere_64_cn)
      ...
      + [在WebLogic群集的JEE上配置Adobe Experience Manager Forms](http://www.adobe.com/go/learn_aemforms_clusterWebLogic_64)
...
+ 升级AEM Forms {#upgrade-aem-forms}
   ...
   + 在JEE上升级AEM Forms {#aem-forms-jee-upgrade}
      ...
      + [Adobe Experience Manager Forms JEE升级检查表和规划](http://www.adobe.com/go/learn_aemforms_upgrade_checklist_64)
      ...
      + [从JEE上的LiveCycleES4 SP1升级到Adobe Experience Manager Forms for JBoss](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-jboss-livecycle.pdf)
      + [在JEE上升级到AEM Forms，以用于JBoss Turnkey](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_64)
      + [从LiveCycleES4 SP1升级到JEE上的Adobe Experience Manager Forms for JBoss Turnkey](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-turnkey-livecycle.pdf)
      + [在JEE上升级到Adobe Experience Manager Forms for WebLogic](http://www.adobe.com/go/learn_aemforms_upgradeWebLogic_64)
      + [从LiveCycleES4 SP1升级到WebLogic JEE上的Adobe Experience Manager Forms](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-weblogic-livecycle.pdf)
      + [在JEE上升级到Adobe Experience Manager Forms for WebSphere](http://www.adobe.com/go/learn_aemforms_upgradeWebSphere_64)
      + [从LiveCycleES4 SP1升级到WebSphere JEE上的Adobe Experience Manager Forms](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-websphere-livecycle.pdf)
...
+ 自适应Forms — 基本创作 {#adaptive-forms-basic-authoring}
   ...
   + [创建无障碍的自适应表单](using/creating-accessible-adaptive-forms.md)
   + [使用可重复部分创建表单](using/creating-forms-repeatable-sections.md)
...
+ 交互式通信 {#interactive-communications}
   ...
   + [互动交流中的文本](using/texts-interactive-communications.md)
...
+ AEM Forms Workspace {#use-aem-forms-workspace}
   ...
   + [骨干互动](using/backbone-interaction.md)
   ...
   + [新的呈现和提交服务](using/new-render-submit-service.md)
   ...
   + [为任务自定义选项卡](using/customizing-tabs-task.md)
   ...
   + [缩小JavaScript文件](using/minification-javascript-files.md)
   ...
   + [在AEM Forms工作区中使用现有流程数据启动新流程](using/initiating-new-process-existing-process.md)
   + [在一个服务器上托管两个AEM Forms工作区实例](using/two-html-workspace-instances-one.md)
   + [更改界面的颜色方案](using/changing-color-scheme-interface.md)
   + [更改界面上的字体](using/changing-font-interface.md)
   + [更改组织标识以进行品牌推广](using/changing-organization-logo-branding.md)
   ...
   + [使用“经理视图”管理组织层次结构中的任务](using/tasks-organizational-hierarchy-using-manager.md)
   ...
   + [将AEM Forms工作区与Microsoft Office SharePoint服务器集成](using/integrating-aem-forms-workspace-with-microsoft-office-sharepoint-server.md)
   + [使用待办事项列表](using/todo-lists.md)
   + [AEM Forms工作区疑难解答准则](using/troubleshooting-guidelines-html-workspace.md)
+ AEM Forms应用程序 {#aem-forms-app}
   ...
   + [AEM Forms应用程序故障诊断](using/issues-aem-forms-app.md)
+ HTML5 表单 {#html5-forms}
   ...
   + [HTML5表单的呈现表单模板](using/rendering-form-template.md)
   ...
   + [HTML5表单中的从右到左语言](using/right-left-languages.md)
   + [将表单桥与用于表单5的自定义门户集成HTML](using/integrate-form-bridge-forms-portal.md)
   + [在HTML5表单中创建自定义外观](using/custom-widgets.md)
   + [更改HTML5表单的默认样式](using/changing-default-styles.md)
   + [对HTML5表单的图片子句支持](using/picture-clause-support.md)
   + [在HTML5表单中创建可访问的复杂表](using/accessible-tables.md)
   + [为HTML5表单创建CSS样式](using/css-styles.md)
   + [为HTML5表单自定义错误消息](using/customzing-errors-html5-forms.md)
   ...
   + [在AEM Forms中设置表单](using/formset-in-aem-forms.md)
+ 信函 {#letters-correspondences}
   ...
   + [信件和交互式通信的后处理](using/submit-letter-topostprocess.md)
   + [向资产列表视图添加自定义操作](using/add-custom-action-asset-listing-view.md)
   ...
   + [用于访问信件实例的API](using/cm-apis-to-access-letter-instances.md)
   + [将创建通信UI与自定义门户集成](using/integrating-create-correspondence-ui-with-your-portal.md)
   + [通信管理中的自定义特殊字符](using/custom-special-characters.md)
   + [信件PDF预览中的自定义水印](using/custom-watermark.md)
   + [配置通信管理解决方案](using/configuring-a-cm-solution.md)
   + [在交互式通信和信件中重复使用内嵌条件](using/cm-inline-condition.md)
   + [文档片段](using/lists.md)
...
+ 将AEM Forms与Experience Cloud解决方案集成 {#integrate-aem-forms-with-experience-cloud-solutions}
   + [在AEM Forms中创建定位体验](/help/forms/using/experience-targeting-forms.md)
   + [衡量并改进表单的有效性和转换](using/measure-improve-performance-forms-documents.md)
...
+ 发布和处理AEM Forms {#publish-process-aem-forms}
   ...
   + [已监视文件夹AEM Forms](using/watched-folder-in-aem-forms.md)
   ...
   + [在“分配任务”步骤中使用自定义电子邮件模板](using/use-custom-email-template-assign-task-step.md)
...
+ 文档服务 {#use-document-services}
   ...
   + [以编程方式使用AEM Document Services](using/aem-document-services-programmatically.md)
...
+ Forms Designer {#use-forms-designer}
   + [使用Designer](http://www.adobe.com/go/learn_aemforms_designer_64_cn)
   + [设计器快速入门Tutorials](http://www.adobe.com/go/learn_aemforms_designer_quick_start_64)
   + [设计器示例](http://www.adobe.com/go/learn_aemforms_designer_samples_64)
   + [设计器脚本基础知识](http://www.adobe.com/go/learn_aemforms_scriptingBasics_64)
   + [设计器脚本参考](http://www.adobe.com/go/learn_aemforms_scriptingReference_64)
   + [设计器表单计算引用](http://www.adobe.com/go/learn_aemforms_formCalc_64)
...
+ 自定义AEM Forms {#customize-aem-forms}
   ...
   + [对表单制表符项目添加自定义操作](using/add-custom-action-form-lister.md)
   + [自定义自适应表单错误消息的布局和位置](using/customize-layout-positioning-error-messages-adaptive-form.md)
...
+ 交易报表 {#transaction-reports}
   + [交易报表概述](using/transaction-reports-overview.md)
   + [查看和了解交易报表](using/viewing-and-understanding-transaction-reports.md)
   + [交易报表计费API](using/transaction-reports-billable-apis.md)
   + [记录自定义实施的交易](using/record-transaction-custom-implementation.md)
+ JEE上AEM Forms的管理员帮助 {#administrator-help}
   + 开始使用 {#get-started}
   ...
   + 配置用户管理 {#configure-user-management}
      ...
      + [配置LDAP绑定密码](/help/forms/using/admin-help/configure-ldap-bind-password.md)
   ...
   + 设置和组织用户 {#setup-organize-users}
      ...
      + [及时用户配置](/help/forms/using/admin-help/just-in-time-user-provisioning.md)
   ...
   + 连接到内容管理系统 {#connect-content-management-system}
      ...
      + [为IBM内容管理器配置连接器](/help/forms/using/admin-help/configuring-connector-ibm-content-manager.md)
      + [为Microsoft SharePoint配置Connector](/help/forms/using/admin-help/configuring-connector-microsoft-sharepoint.md)
   + 管理证书和凭据 {#manage-certificates-credentials}
      + [添加和删除用户名和密码凭据](/help/forms/using/admin-help/adding-removing-user-name-password.md)
      + [管理证书缩写列表](/help/forms/using/admin-help/certificate-revocation-lists.md)
   ...
   + 配置Acrobat Reader DC扩展 {#configure-acrobat-reader-dc-extensions}
      ...
      + [审核凭据使用信息](/help/forms/using/admin-help/review-credential-information.md)
      + [配置用于Acrobat Reader DC扩展的凭据](/help/forms/using/admin-help/configuring-credentials-acrobat-reader-dc.md)
   ...
   + 使用文档安全 {#work-with-document-security}
      ...
      + [大容量安全信息传送](/help/forms/using/admin-help/high-volume-secure-information-delivery.md)
      + [配置客户端和服务器选项](/help/forms/using/admin-help/configuring-client-server-options.md)
      + [管理受邀和本地用户帐户](/help/forms/using/admin-help/invited-local-user-accounts.md)
   ...
   + 配置表单工作流{#configure-forms-workflow}
      ...
      + [配置“不在办公室”设置](/help/forms/using/admin-help/configuring-out-office-settings.md)
   ...
   + 运行状况监视器 {#health-monitor}
      ...
      + [查看与Work Manager相关的统计信息](/help/forms/using/admin-help/view-statistics-related-manager.md)
   ...
   + 维护AEM表单数据库 {#maintain-aem-forms-database}
      ...
      + [最大限度地减少数据库增长的提示](/help/forms/using/admin-help/tips-minimizing-database-growth.md)
   + 维护应用程序服务器 {#manage-application-server}
      ...
      + [提高应用程序服务器性能](/help/forms/using/admin-help/enhancing-application-server-performance.md)
   ...
   + AEM表单备份和恢复 {#aem-forms-backup-recovery}
      ...
      + [已监视文件夹的备份策略](/help/forms/using/admin-help/backup-strategies-watched-folders.md)
      + [恢复AEM表单数据](/help/forms/using/admin-help/recovering-aem-forms-data.md)
      + [面向EMC Documentum用户的Connector备份策略](/help/forms/using/admin-help/backup-strategy-connector-emc-documentum.md)
...
+ 流程报告 {#process-reporting}
   ...
   + [流程报表中的预定义报表](/help/forms/using/process-reporting/pre-defined-reports-in-process-reporting.md)
   + [流程中的自定义报表](/help/forms/using/process-reporting/process-reporting-custom-reports.md)
...
+ 开发人员参考 {#developer-reference}
   ...
   + [适用于自适应Forms的JavaScript库API引用](https://helpx.adobe.com/experience-manager/6-4/forms/javascript-api/index.html)
   + [汇编程序服务和DDX参考](http://www.adobe.com/go/learn_aemforms_ddxRef_64)
   + [Workbench帮助](http://www.adobe.com/go/learn_aemforms_workbench_64)
   + 在JEE上使用AEM Forms进行编程 {#programming-aem-forms-jee}
      ...
      + Java API快速入门 — 代码示例 {#java-api-quick-start-code-examples}
         ...
         + [汇编程序服务Java API快速入门(SOAP)](developing/assembler-service-java-api-quick.md)
         ...
         + [条形码Forms服务Java APIQ快速开始(SOAP)](developing/barcoded-forms-service-java-api.md)
         ...
         + [Distiller服务Java API快速入门(SOAP)](developing/distiller-service-java-api-quick.md)
         ...
         + [文档安全服务JavaAPI快速入门(SOAP)](developing/document-security-service-java-api.md)
         + [加密服务Java API快速入门(SOAP)](developing/encryption-service-java-api-quick.md)
         ...
         + [生成PDF服务Java API快速入门(SOAP)](developing/generate-pdf-service-java-api.md)
         + [调用API快速入门](developing/invocation-api-quick-starts.md)
         + [LiveCycleProcess Java API(SOAP)快速入门](developing/livecycleprocess-java-api-soap-quick.md)
      ...
      + 在JEE上使用API调用AEM Forms {#invoking-aem-forms-jee-apis}
      ...
      + 使用API执行服务操作 {#performing-service-operations-using-apis}
         ...
         + [在文件格式之间转换和PDF](developing/converting-file-formats-pdf.md)
         + [以编程方式拆分PDF文档](developing/programmatically-disassembling-pdf-documents.md)
         + [汇编加密PDF文档](developing/assembling-encrypted-pdf-documents.md)
         + [组装多个XDP片段](developing/assembling-multiple-xdp-fragments.md)
         + [使用Bates编号组合文档](developing/assembling-documents-using-bates-numbering.md)
         ...
         + [组装PDFPortfolio](developing/assembling-pdf-portfolios.md)
         ...
         + [使用Web服务API拆解PDF文档](developing/disassemble-pdf-document-using-web.md)
         + [确定文档是否符合PDF/A](developing/determining-whether-documents-pdf-a.md)
         + [动态创建DDX文档](developing/dynamically-creating-ddx-documents.md)
         + [处理已提交的Forms](developing/handling-submitted-forms.md)
         ...
         + [使用可流动布局预填充Forms](developing/prepopulating-forms-flowable-layouts.md)
         + [基于片段渲染Forms](developing/rendering-forms-based-fragments.md)
         ...
         + [呈现HTMLForms（使用自定义CSS文件）](developing/rendering-html-forms-using-custom.md)
         + [使用自定义工具栏呈现HTMLForms](developing/rendering-html-forms-custom-toolbars.md)
         + [呈现交互式PDF forms](developing/rendering-interactive-pdf-forms.md)
         + [启用渲染权限的Forms](developing/rendering-rights-enabled-forms.md)
         + [验证DX文档](developing/validating-ddx-documents.md)
