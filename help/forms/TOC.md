...
+ 安装和配置AEM Forms{#install-aem-forms}
   ...
   + 在OSGi {#osgi-installation}上安装AEM Forms
      + [支持AEM表单在OSGi上的平台](https://helpx.adobe.com/experience-manager/6-4/sites/deploying/using/technical-requirements.html)
   ...
   + 在JEE上安装AEM Forms{#jee-installation}
      ...
      + [在JEE上安装和部署JBoss的Adobe Experience Manager Forms](http://www.adobe.com/go/learn_aemforms_installJBoss_64)
      + [在WebLogic的JEE上安装和部署AEM Forms](http://www.adobe.com/go/learn_aemforms_installWebLogic_64)
      + [在WebSphere的JEE上安装和部署Adobe Experience Manager Forms](http://www.adobe.com/go/learn_aemforms_installWebSphere_64)
      ...
      + [在JBoss群集上在JEE上配置Adobe Experience Manager Forms](http://www.adobe.com/go/learn_aemforms_clusterJBoss_64)
      + [在WebLogic群集上在JEE上配置Adobe Experience Manager Forms](http://www.adobe.com/go/learn_aemforms_clusterWebLogic_64)
      + [在WebSphere群集上在JEE上配置Adobe Experience Manager Forms](http://www.adobe.com/go/learn_aemforms_clusterWebSphere_64)
...
+ 升级AEM Forms{#upgrade-aem-forms}
   ...
   + 升级JEE上的AEM Forms{#aem-forms-jee-upgrade}
      ...
      + [Adobe Experience Manager FormsJEE升级清单和计划](http://www.adobe.com/go/learn_aemforms_upgrade_checklist_64)
      + [升级到JEE上的AEM 6.4表单](using/upgrade-forms-jee.md)
      + [升级到Adobe Experience Manager FormsJEE for JBoss](http://www.adobe.com/go/learn_aemforms_upgradeJBoss_64)
      + [从LiveCycleES4 SP1升级到JEE上的JBoss的Adobe Experience Manager Forms](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-jboss-livecycle.pdf)
      + [升级到AEM FormsJEE for JBoss Turnkey](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_64)
      + [从LiveCycleES4 SP1升级到JEE上的JBoss Turnkey](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-turnkey-livecycle.pdf)
      + [在WebLogic的JEE上升级到Adobe Experience Manager Forms](http://www.adobe.com/go/learn_aemforms_upgradeWebLogic_64)
      ...
      + [在WebSphere的JEE上升级到Adobe Experience Manager Forms](http://www.adobe.com/go/learn_aemforms_upgradeWebSphere_64)
...
+ 自适应Forms-基本创作{#adaptive-forms-basic-authoring}
   ...
   + [AEM Forms占位符文本](using/placeholder-text-in-aem-forms-.md)
...
+ 自适应Forms-高级创作{#adaptive-forms-advanced-authoring}
   ...
   + [将Adobe Sign与AEM Forms整合](using/adobe-sign-integration-adaptive-forms.md)
...
+ AEM Forms工作区{#use-aem-forms-workspace}
   ...
   + [AEM Forms工作区功能在Flex工作区中不可用](using/features-html-workspace-available-flex.md)
   ...
   + [利用AEM Forms工作区中的现有流程数据启动新流程](using/initiating-new-process-existing-process.md)
...
+ 发布和处理AEM Forms{#publish-process-aem-forms}
   ...
   + [在AEM Forms监视文件夹](using/watched-folder-in-aem-forms.md)
...
+ 文档服务 {#use-document-services}
   ...
   + [巴科德Forms](using/using-barcoded-forms-service.md)
...
+ AEM FormsJEE {#administrator-help}管理员帮助
   ...
   + AEM forms备份和恢复{#aem-forms-backup-recovery}
      ...
      + [AEM表单的备份和恢复战略](/help/forms/using/admin-help/backup-recovery-strategy-aem-forms.md)
...
+ 开发人员参考{#developer-reference}
   ...
   + 在JEE上与AEM Forms一起编程{#programming-aem-forms-jee}
      ...
      + Java API快速开始-代码示例{#java-api-quick-start-code-examples}
         ...
         + [BarcodedForms服务Java APIQ快速开始(SOAP)](developing/barcoded-forms-service-java-api.md)
         ...
         + [Distiller服务Java API QuickStart(SOAP)](developing/distiller-service-java-api-quick.md)
         ...
         + [Forms服务API快速开始](developing/forms-service-api-quick-starts.md)
      ...
      + 使用API{#performing-service-operations-using-apis}执行服务操作
         ...
         + [创建呈现Forms的Web 应用程序](developing/creating-web-applications-renders-forms.md)
         ...
         + [基于片段呈现Forms](developing/rendering-forms-based-fragments.md)
         + [按价值呈现Forms](developing/rendering-forms-value.md)
         ...
         + [准备AEM Forms备份](developing/preparing-aem-forms-backup.md)
