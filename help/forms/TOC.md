...
sub-product: '表单 '
audience: end-user
user-guide-title: Adobe Experience Manager六点四Forms指南
...
# Adobe Experience Manager六点四Forms指南 {#forms}

+ [AEM 6.4 Forms 用户指南](home.md)
...
+ 安装和配置AEM Forms {#install-aem-forms}
   ...
   + Install AEM Forms on JEE {#jee-installation}
      ...
      + [在JBoss群集上在JEE上配置AEM Forms](http://www.adobe.com/go/learn_aemforms_clusterJBoss_64)
      + [在WebLogic群集上在JEE上配置AEM Forms](http://www.adobe.com/go/learn_aemforms_clusterWebLogic_64)
      + [在WebSphere群集上在JEE上配置AEM Forms](http://www.adobe.com/go/learn_aemforms_clusterWebSphere_64)
...
+ 升级AEM Forms {#upgrade-aem-forms}
   ...
   + 升级JEE上的AEM Forms {#aem-forms-jee-upgrade}
      ...
      + [从AEM Forms版本升级到AEM 6.4FormsJEE for JBoss](http://www.adobe.com/go/learn_aemforms_upgradeJBoss_64)
      ...
      + [从AEM Forms版本升级到AEM 6.4Forms的JEE for JBoss trunky](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_64)
      ...
      + [从AEM Forms版本升级到AEM 6.4Forms的JEE for WebLogic](http://www.adobe.com/go/learn_aemforms_upgradeWebLogic_64)
      + [从LiveCycleES4 SP1升级到WebLogic JEE上的AEM Forms](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-weblogic-livecycle.pdf)
      + [从AEM Forms版本升级到AEM 6.4Forms的WebSphere JEE版](http://www.adobe.com/go/learn_aemforms_upgradeWebSphere_64)
      + [从LiveCycleES4 SP1升级到WebSphere JEE上的AEM Forms](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-websphere-livecycle.pdf)
