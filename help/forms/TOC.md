...
# AEM 6.4 - Forms用户指南 {#forms}

+ [AEM 6.4 Forms用户指南](home.md)
...
+ 入门 {#getting-started}
   ...
   + AEM Forms Reference Acrobus {#aem-forms-reference-collaterals}
...
+ 安装和配置AEM表单 {#install-aem-forms}
   ...
   + Install AEM Forms on JEE {#jee-installation}
      ...
      + [在JEE上安装和部署AEM Forms for JBoss](http://www.adobe.com/go/learn_aemforms_installJBoss_64)
      ...
      + [准备安装AEM Forms服务器群集](http://www.adobe.com/go/learn_aemforms_prepareInstallcluster_64)
      + [在JBoss群集上的JEE上配置AEM Forms](http://www.adobe.com/go/learn_aemforms_clusterJBoss_64)
      + [在WebLogic群集上的JEE上配置AEM Forms](http://www.adobe.com/go/learn_aemforms_clusterWebLogic_64)
      + [在WebSphere群集上的JEE上配置AEM Forms](http://www.adobe.com/go/learn_aemforms_clusterWebSphere_64)
   + 设定 AEM Forms {#configure-aem-forms}
      ...
      + [配置Connector for Microsoft SharePoint](http://help.adobe.com/en_US/AEMForms/6.1/SharePointConfig/index.html)
      + [将AEM Forms与Adobe LiveCycle连接](using/aem-livecycle-connector.md)
      + [将AEM Forms配置为在JEE流程中将表单数据提交到AEM Forms](using/submit-form-data-livecycle-process.md)
...
+ 升级AEM Forms {#upgrade-aem-forms}
   ...
   + 在OSGi上升级AEM Forms {#aem-forms-osgi-upgrade}
      + [升级到OSGi上的AEM 6.4表单](using/upgrade-forms-osgi.md)
   ...
   + 在JEE上升级AEM Forms {#aem-forms-jee-upgrade}
      ...
      + [升级清单和计划](http://www.adobe.com/go/learn_aemforms_upgrade_checklist_64)
      + [升级到JEE上的AEM 6.4表单](using/upgrade-forms-jee.md)
      + [从AEM Forms版本升级到JEE上的AEM 6.4 Forms for JBoss](http://www.adobe.com/go/learn_aemforms_upgradeJBoss_64)
...
+ 管理AEM表单 {#manage-administer-aem-forms}
   ...
   + 处理用户数据 {#handling-user-data}
      + [OSGi上以表单为中心的工作流程](using/forms-workflow-osgi-handling-user-data.md)
   ...
   + 强化AEM表单环境 {#hardening-aem-forms-environment}
      ...
      + [在JEE环境中强化AEM表单](using/hardening-aem-forms-jee-environment.md)
...
+ 自适应表单——基本创作 {#adaptive-forms-basic-authoring}
   ...
   + [使用涂鸦式签名将电子签名应用于表单](using/signing-forms-using-scribble.md)
...
+ 自适应表单——高级创作 {#adaptive-forms-advanced-authoring}
   ...
   + [在Designer中更改“零页”内容](using/changing-page-zero-content-designer.md)
   + [授予规则编辑器对选定用户组的访问权限](using/rule-editor-access-user-groups.md)
...
+ 工作流 {#workflows}
   ...
   + [以表单为中心的AEM工作流在OSGi和AEM Forms JEE工作流上的操作和功能](using/capabilities-osgi-jee-workflows.md)
...
+ AEM Forms Workspace {#use-aem-forms-workspace}
   ...
   + [AEM Forms工作区中不提供Flex工作区的功能](using/features-flex-workspace-available-html.md)
   + [骨干交互](using/backbone-interaction.md)
   + [可重用组件的说明](using/description-reusable-components.md)
   + [渲染器的文档详细信息](using/document-details-renderer.md)
   ...
   + [AEM Forms工作区JSON对象说明](using/html-workspace-json-object-description.md)
   ...
   + [获取摘要URL中的任务变量](using/getting-task-variables-summary-url.md)
   ...
   + [使用“管理者视图”管理组织层次结构中的任务](using/tasks-organizational-hierarchy-using-manager.md)
...
+ HTML5 表单 {#html5-forms}
   ...
   + [HTML5表单与PDF表单的功能区分](using/feature-differentiation-html5-forms-pdf-forms.md)
...
+ 字母与对应 {#letters-correspondences}
   ...
   + [将“创建对应UI”与自定义门户集成](using/integrating-create-correspondence-ui-with-your-portal.md)
...
+ 将AEM Forms与Experience Cloud解决方案集成 {#integrate-aem-forms-with-experience-cloud-solutions}
   ...
   + [查看和了解AEM Forms分析报告](using/view-understand-aem-forms-analytics-reports.md)
   + [创建和管理自适应表单的A/B测试](using/ab-testing-adaptive-forms.md)
+ 发布和处理AEM表单 {#publish-process-aem-forms}
   ...
   + [AEM Forms中的监视文件夹](using/watched-folder-in-aem-forms.md)
...
+ Forms Designer {#use-forms-designer}
   ...
   + [设计人员快速入门教程](http://www.adobe.com/go/learn_aemforms_designer_quick_start_64)
   + [设计人员范例](http://www.adobe.com/go/learn_aemforms_designer_samples_64)
   + [设计人员脚本基础知识](http://www.adobe.com/go/learn_aemforms_scriptingBasics_64)
   + [设计人员脚本参考](http://www.adobe.com/go/learn_aemforms_scriptingReference_64)
   + [设计器表单Calc参考](http://www.adobe.com/go/learn_aemforms_formCalc_64)
   + [在HTML5表单中使用涂抹签名](using/scribble-signature.md)
+ 自定义AEM表单 {#customize-aem-forms}
...
+ 事务报表 {#transaction-reports}
   + [事务处理报告概述](using/transaction-reports-overview.md)
   + [查看和了解事务处理报表](using/viewing-and-understanding-transaction-reports.md)
   + [事务处理报告可开单API](using/transaction-reports-billable-apis.md)
   + [记录自定义实现的事务](using/record-transaction-custom-implementation.md)
+ JEE上的AEM Forms管理员帮助 {#administrator-help}
   + 开始使用 {#get-started}
      + [常规AEM表单设置](/help/forms/using/admin-help/configure-general-aem-forms-settings.md)
   ...
   + 配置用户管理 {#configure-user-management}
      ...
      + [配置SAML服务提供者设置](/help/forms/using/admin-help/configure-saml-service-provider-settings.md)
   ...
   + 设置和组织用户 {#setup-organize-users}
      ...
      + [创建和配置用户组](/help/forms/using/admin-help/creating-configuring-groups.md)
   ...
   + 管理证书和凭据 {#manage-certificates-credentials}
      ...
      + [管理证书拒绝列表](/help/forms/using/admin-help/certificate-revocation-lists.md)
   ...
   + 配置Acrobat Reader DC扩展 {#configure-acrobat-reader-dc-extensions}
      ...
      + [配置Acrobat Reader DC扩展以获取数据](/help/forms/using/admin-help/configuring-acrobat-reader-dc-extensions.md)
   ...
   + 使用PDF生成器 {#work-with-pdf-generator}
      ...
      + [配置备用字体](/help/forms/using/admin-help/configuring-fallback-fonts.md)
   ...
   + 使用文档安全性 {#work-with-document-security}
      ...
      + [大容量安全信息交付](/help/forms/using/admin-help/high-volume-secure-information-delivery.md)
   ...
   + 配置表单 {#configure-forms}
      ...
      + [配置表单的位置](/help/forms/using/admin-help/configuring-locations-forms.md)
   ...
   + 配置表单工作流{#configure-forms-workflow}
      ...
      + [表单工作流程概述](/help/forms/using/admin-help/overview-9.md)
   ...
   + 健康监视器 {#health-monitor}
      + [健康监视器概述](/help/forms/using/admin-help/overview-11.md)
   ...
   + 维护应用程序服务器 {#manage-application-server}
      ...
      + [启动和停止WebLogic Server](/help/forms/using/admin-help/starting-stopping-weblogic-server.md)
...
+ 进程报告 {#process-reporting}
   + [流程报表简介](/help/forms/using/process-reporting/introduction-process-reporting.md)
   + [流程报表入门](/help/forms/using/process-reporting/install-start-process-reporting.md)
   ...
   + [流程中的自定义报告](/help/forms/using/process-reporting/process-reporting-custom-reports.md)
...
+ 开发人员参考 {#developer-reference}
   ...
   + [JEE Java API参考上的AEM Forms](https://helpx.adobe.com/experience-manager/6-4/forms/ProgramLC/javadoc/index.html)
   + [HTML5表单的Form Bridge API](using/form-bridge-apis.md)
   + [汇编器服务和DDX参考](http://www.adobe.com/go/learn_aemforms_ddxRef_64)
   ...
   + 在JEE上使用AEM Forms进行编程 {#programming-aem-forms-jee}
      ...
      + Java API快速入门——代码示例 {#java-api-quick-start-code-examples}
         ...
         + [组件和服务Java APIQ快速启动(SOAP)](developing/components-services-java-api-quick.md)
      ...
      + 使用API执行服务操作 {#performing-service-operations-using-apis}
         ...
         + [创建呈现表单的Web应用程序](developing/creating-web-applications-renders-forms.md)
         ...
         + [基于片段渲染表单](developing/rendering-forms-based-fragments.md)
         ...
         + [渲染交互式PDF表单](developing/rendering-interactive-pdf-forms.md)
         + [渲染启用了权限的表单](developing/rendering-rights-enabled-forms.md)
         ...
         + [对文档进行数字签名和认证](developing/digitally-signing-certifying-documents.md)
