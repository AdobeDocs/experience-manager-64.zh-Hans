...
以下Java代码示例将两个名为* map.pdf*的PDF源文档和 *directions.pdf* 合并到一个PDF文档中。 单个PDF文档的名称为 *AssemblerResultPDF.pdf*。 DDX文档的名称为 *shell.xml*。 (请参阅 [以编程方式组合PDF文档](/help/forms/developing/assembling-pdf-documents.md#programmatically-assembling-pdf-documents)。)
