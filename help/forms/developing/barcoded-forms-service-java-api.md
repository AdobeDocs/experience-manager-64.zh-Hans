---
title: Barcoded Forms Service Java APIQ快速启动(SOAP)
seo-title: Barcoded Forms Service Java APIQ快速启动(SOAP)
description: 'null'
...
# Barcoded Forms Service Java API快速入门(SOAP) {#barcoded-forms-service-java-apiquick-start-soap}

Java API Quick Start(SOAP)可用于Barcoded Forms服务：
...
***注意&#x200B;**:使用AEM Forms进行编程中的“快速入门”基于JBoss Application server和Microsoft windows操作系统上部署的Forms Server。 但是，如果您使用的是其他操作系统（如UNIX），请将特定于Windows的路径替换为适用操作系统支持的路径。 同样，如果您使用的是另一台J2EE应用程序服务器，请确保指定有效的连接属性。 (请参阅[设置连接属性](/help/forms/developing/invoking-aem-forms-using-java.md#setting-connection-properties)。)*
