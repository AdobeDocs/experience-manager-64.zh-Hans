...
以下代码示例将名为 *Loan.pdf的PDF文档转换为名为* Loan.ps的PostScript文档 **。 (请参 [阅将PDF文档转换为PostScript](/help/forms/developing/converting-pdf-postscript-image-files.md#converting-pdf-documents-to-postscript)。)
