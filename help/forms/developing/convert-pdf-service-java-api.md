---
title: 转换PDF服务Java API QuickStart(SOAP)
seo-title: 转换PDF服务Java API QuickStart(SOAP)
description: 使用“转换PDF服务Java API”将PDF文档转换为PostScript和JPEG文件。
seo-description: 使用“转换PDF服务Java API”将PDF文档转换为PostScript和JPEG文件。
...
# 转换PDF服务Java API快速开始(SOAP){#convert-pdf-service-java-api-quickstart-soap}

以下快速开始可用于转换PDF服务API。

[快速开始（SOAP模式）:使用Java API将PDF文档转换为PostScript](convert-pdf-service-java-api.md#quick-start-soap-mode-converting-a-pdf-document-to-postscript-using-the-java-api)

[快速开始（SOAP模式）:使用Java API将PDF文档转换为JPEG文件](convert-pdf-service-java-api.md#quick-start-soap-mode-converting-a-pdf-document-to-jpeg-files-using-the-java-api)
...
## 快速开始（SOAP模式）:使用Java API {#quick-start-soap-mode-converting-a-pdf-document-to-postscript-using-the-java-api}将PDF文档转换为PostScript

下面的代码示例将名为&#x200B;*Loan.pdf*&#x200B;的PDF文档转换为名为&#x200B;*Loan.ps*&#x200B;的PostScript文档。 (请参阅[将PDF文档转换为PostScript](/help/forms/developing/converting-pdf-postscript-image-files.md#converting-pdf-documents-to-postscript)。)
...
## 快速开始（SOAP模式）:使用Java API {#quick-start-soap-mode-converting-a-pdf-document-to-jpeg-files-using-the-java-api}将PDF文档转换为JPEG文件

以下Java代码示例将名为&#x200B;*Loan.pdf*&#x200B;的PDF文档转换为一组JPEG文件，并将它们存储在C:\Adobe directory文件夹中。 每个文件均命名为&#x200B;*tempFile[index].jpg*，其中第一个图像文件命名为&#x200B;*tempFile0.jpg*。 (请参阅[将PDF文档转换为图像格式](/help/forms/developing/converting-pdf-postscript-image-files.md#converting-pdf-documents-to-image-formats)。)
