...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>指定如何响应特定于应用程序的对话框。 </p><p>包含此信息的文件是appmon。<i>[appname]</i>.dialog。<i>[区域设置]</i>.xml（例如appmon.word.en_US.xml）。</p></td> 
...
1. 在“新建系统变量”对话框的&#x200B;**变量名称**&#x200B;框中，键入使用&#x200B;*[applicationname]*_PATH格式的名称。
