---
title: DocConverter服务Java API快速启动(SOAP)
seo-title: DocConverter服务Java API快速启动(SOAP)
description: 使用DocConverter Service Java API确定PDF/A合规性，并将文档转换为PDF/A文档。
seo-description: 使用DocConverter Service Java API确定PDF/A合规性，并将文档转换为PDF/A文档。
...
# DocConverter服务Java API快速启动(SOAP){#docconverter-service-java-api-quickstart-soap}

Java API快速入门(SOAP)可用于DocConverter服务。

[快速入门（SOAP模式）：使用Java API确定PDF/A合规性](docconverter-service-java-api-quick.md#quick-start-soap-mode-determining-pdf-a-compliancy-using-the-java-api)
...
## 快速入门（SOAP模式）：使用Java API {#quick-start-soap-mode-converting-a-document-to-a-pdf-a-document-using-the-java-api}将文档转换为PDF/A文档

以下Java代码示例将名为&#x200B;*Loan.pdf*&#x200B;的PDF文档转换为PDF/A文档，该文档另存为名为&#x200B;*LoanArchive.pdf*&#x200B;的PDF文件。 （请参阅[将文档转换为PDF/A文档](/help/forms/developing/pdf-a-documents.md#converting-documents-to-pdf-a-documents)。）
...
## 快速入门（SOAP模式）：使用Java API {#quick-start-soap-mode-determining-pdf-a-compliancy-using-the-java-api}确定PDF/A合规性

以下Java代码示例确定输入的PDF文档是否符合PDF/A规范。 传递到DocConverter服务的输入PDF文档名为&#x200B;*LoanArchive.pdf*。 验证结果将写入名为&#x200B;*ValidationResults.xml*&#x200B;的XML文件。 （请参阅[以编程方式确定PDF/A合规性](/help/forms/developing/pdf-a-documents.md#programmatically-determining-pdf-a-compliancy)。）
