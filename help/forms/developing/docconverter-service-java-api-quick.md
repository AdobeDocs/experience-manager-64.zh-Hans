...
description: 使用DocConverter Service Java API确定PDF/A规范并将文档转换为PDF/A文档。
seo-description: 使用DocConverter Service Java API确定PDF/A规范并将文档转换为PDF/A文档。
...
# DocConverter Service Java API快速开始(SOAP){#docconverter-service-java-api-quickstart-soap}
...
## 快速开始（SOAP模式）：使用Java API {#quick-start-soap-mode-converting-a-document-to-a-pdf-a-document-using-the-java-api}将文档转换为PDF/A文档

以下Java代码示例将名为&#x200B;*Loan.pdf*&#x200B;的PDF文档转换为保存为名为&#x200B;*LoanArchive.pdf*&#x200B;的PDF文件的PDF/A文档。 (请参阅[将文档转换为PDF/A文档](/help/forms/developing/pdf-a-documents.md#converting-documents-to-pdf-a-documents)。)
...
## 快速开始（SOAP模式）：使用Java API {#quick-start-soap-mode-determining-pdf-a-compliancy-using-the-java-api}确定PDF/A兼容性

以下Java代码示例确定输入的PDF文档是否与PDF/A兼容。 传递给DocConverter服务的输入PDF文档名为&#x200B;*LoanArchive.pdf*。 验证结果将写入名为&#x200B;*ValidationResults.xml*&#x200B;的XML文件。 （请参阅[以编程方式确定PDF/A兼容性](/help/forms/developing/pdf-a-documents.md#programmatically-determining-pdf-a-compliancy)。）
