...
seo-title: 生成PDF服务Java API快速入门(SOAP)
description: 使用“生成PDF”服务将Microsoft Word文档转换为PDF文档、将HTML内容转换为PDF文档、使用Java API将PDF文档转换为RTF文件。
seo-description: 使用“生成PDF”服务将Microsoft Word文档转换为PDF文档、将HTML内容转换为PDF文档、使用Java API将PDF文档转换为RTF文件。
...
# 生成PDF服务Java API快速入门(SOAP){#generate-pdf-service-java-api-quickstart-soap}

Java API快速入门(SOAP)适用于“生成PDF”服务。

[快速入门（SOAP模式）：使用Java API将Microsoft Word文档转换为PDF文档](generate-pdf-service-java-api.md#quick-start-soap-mode-converting-a-microsoft-word-document-to-a-pdf-document-using-the-java-api)

[快速入门（SOAP模式）：使用Java API将HTML内容转换为PDF文档](generate-pdf-service-java-api.md#quick-start-soap-mode-converting-html-content-to-a-pdf-document-using-the-java-api)
...
## 快速入门（SOAP模式）：使用Java API {#quick-start-soap-mode-converting-a-microsoft-word-document-to-a-pdf-document-using-the-java-api}将Microsoft Word文档转换为PDF文档

以下代码示例将名为&#x200B;*Loan.doc*&#x200B;的Word文件转换为名为&#x200B;*Loan.pdf*&#x200B;的PDF文档。 （请参阅[将Word文档转换为PDF文档](/help/forms/developing/converting-file-formats-pdf.md#converting-word-documents-to-pdf-documents)。）
...
## 快速入门（SOAP模式）：使用Java API {#quick-start-soap-mode-converting-html-content-to-a-pdf-document-using-the-java-api}将HTML内容转换为PDF文档
...
## 快速入门（SOAP模式）：使用Java API（SOAP模式）{#quick-start-soap-mode-converting-a-pdf-document-to-an-rtf-file-using-the-java-api-soap-mode}将PDF文档转换为RTF文件
