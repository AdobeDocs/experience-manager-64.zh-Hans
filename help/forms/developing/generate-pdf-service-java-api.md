...
seo-title: 生成PDF服务Java API快速启动(SOAP)
...
下面的代码示例将名为&#x200B;*Loan.pdf*&#x200B;的PDF文档转换为名为&#x200B;*Loan.rtf*&#x200B;的RTF文档。 (请参阅[将PDF文档转换为非图像格式](/help/forms/developing/converting-file-formats-pdf.md#converting-pdf-documents-to-non-image-formats)。)
