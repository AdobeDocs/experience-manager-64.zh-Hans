...
<table> 
 ...
 <tbody>
  <tr> 
   ...
   <td><p><a href="/help/forms/developing/invoking-human-centric-long-lived.md#invoking-a-long-lived-process-using-remoting">使用(AEM表单已弃用)调用长寿命进程AEM FormsRemoting</a></p></td> 
  ...
  <tr> 
   <td><p><a href="/help/forms/developing/invoking-aem-forms-using-java.md#invoking_a_short_lived_process_using_the_invocation_api">使用调用API调用短时进程</a></p></td> 
   <td><p>不适用</p></td> 
   <td><p><a href="invocation-api-quick-starts.md#quick_start_invoking_a_short_lived_process_using_the_invocation_api">快速开始:使用调用API调用短时进程</a></p></td> 
   <td><p>不适用</p></td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td><p>不适用</p></td> 
   <td><p>不适用</p></td> 
   <td><p><a href="invocation-api-quick-starts.md#quick_start_invoking_a_service_using_blob_data_over_http_in_a_net_project">快速开始:在。NET项目中使用BLOB数据通过HTTP调用服务</a></p></td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td><p><a href="/help/forms/developing/invoking-aem-forms-using-remoting.md#invoking-aem-forms-using-remoting">调用AEM Forms使用(AEM表单已弃用)AEM Forms远程处理</a></p></td> 
   <td><p><a href="invocation-api-quick-starts.md#quick-start-invoking-a-short-lived-process-by-passing-an-unsecure-document-using-deprecated-for-aem-forms-aem-forms-remoting">快速开始:通过使用(AEM表单已弃用)AEM Forms远程处理传递不安全文档来调用短时过程</a></p></td> 
   <td><p>不适用</p></td> 
   <td><p>不适用</p></td> 
  </tr> 
  <tr> 
   ...
   <td><p><a href="/help/forms/developing/invoking-aem-forms-using-remoting.md#quick-start-invoking-a-short-lived-process-by-passing-a-secure-document-using-remoting">快速开始:通过使用(AEM表单已弃用)AEM Forms·远程处理传递安全文档来调用短时过程</a></p></td> 
   <td><p>不适用</p></td> 
   <td><p>不适用</p></td> 
  </tr> 
  <tr> 
   <td><p><a href="/help/forms/developing/invoking-aem-forms-using-remoting.md#invoking_custom_component_services_using_remoting">使用远程处理调用自定义组件服务</a></p></td> 
   <td><p><a href="/help/forms/developing/invoking-aem-forms-using-remoting.md#quick-start-invoking-the-customer-custom-service-using-remoting">快速开始:使用(AEM表单已弃用)调用客户自定义服务AEM FormsRemoting</a></p></td> 
   <td><p>不适用</p></td> 
   <td><p>不适用</p></td> 
  </tr> 
 </tbody> 
...
>[!NOTE]
>
>使用AEM表单进行编程中的快速开始基于部署在JBoss Application Server和Microsoft Windows操作系统上的Forms服务器。 但是，如果您使用的是其他操作系统（如UNIX），请将Windows特定路径替换为适用操作系统支持的路径。 同样，如果您使用的是另一台J2EE应用程序服务器，请确保指定有效的连接属性。 请参阅[设置连接属性](/help/forms/developing/invoking-aem-forms-using-java.md#setting-connection-properties)。

## 快速开始:使用调用API {#quick-start-invoking-a-short-lived-process-using-the-invocation-api}调用短时进程

以下Java代码示例调用名为`MyApplication/EncryptDocument`的短时进程。 请注意，同步调用此进程。 此进程的输入参数名为`inDoc`。 此进程的输出参数名为`outDoc`。 密码加密的PDF文档将保存为名为`EncryptLoan.pdf`的PDF文件。 （请参阅[使用调用API](/help/forms/developing/invoking-aem-forms-using-java.md#invoking-a-short-lived-process-using-the-invocation-api)调用短时间进程。）
...
基于名为&#x200B;*Loan.pdf*&#x200B;的PDF文件的无担保PDF文档将传递给AEM Forms进程。 该过程返回一个密码加密的PDF文档，它保存为名为&#x200B;*EncryptedPDF.pdf*&#x200B;的PDF文件。
...
基于名为&#x200B;*Loan.pdf*&#x200B;的PDF文件的无担保PDF文档将传递给AEM Forms进程。 该过程返回一个密码加密的PDF文档，它保存为名为&#x200B;*EncryptedDocument.pdf*&#x200B;的PDF文件。
...
## 快速开始:通过使用(AEM表单已弃用)AEM Forms远程{#quick-start-invoking-a-short-lived-process-by-passing-an-unsecure-document-using-deprecated-for-aem-forms-aem-forms-remoting}传递不安全文档来调用短时过程

以下Flex代码示例调用名为`MyApplication/EncryptDocument`的短时进程。 (请参阅[调用AEM Forms(AEM表单已弃用)AEM Forms·远程处理](/help/forms/developing/invoking-aem-forms-using-remoting.md#invoking-aem-forms-using-remoting)。)

>[!NOTE]
>
>此快速开始调用AEM Forms进程并上传不安全文档。 要执行此快速开始，必须将AEM Forms配置为上传不安全文档。 有关如何配置AEM Forms以接受不安全文档的信息，请参见[配置AEM Forms以接受安全和不安全文档](/help/forms/developing/invoking-aem-forms-using-remoting.md#configuring-aem-forms-to-accept-secure-and-unsecure-documents)。
...
基于名为&#x200B;*map.pdf*&#x200B;的PDF文件的不安全PDF文档使用DIME传递到AEM Forms进程。 该过程返回一个密码加密的PDF文档，它保存为名为&#x200B;*mapEncrypt.pdf*&#x200B;的PDF文件。
...
基于名为&#x200B;*Loan.pdf*&#x200B;的PDF文件的无担保PDF文档使用DIME传递到AEM Forms进程。 该过程返回一个密码加密的PDF文档，它保存为名为&#x200B;*EncryptLoan.pdf*&#x200B;的PDF文件。
...
## 快速开始:在Java项目{#quick-start-invoking-a-service-using-blob-data-over-http-in-a-java-project}中使用BLOB数据通过HTTP调用服务

以下Java代码示例使用HTTP上的数据调用名为`MyApplication/EncryptDocument`的进程。 (请参阅[通过HTTP](/help/forms/developing/invoking-aem-forms-using-web.md#invoking-aem-forms-using-blob-data-over-http)使用BLOB数据调用AEM Forms。)

基于名为&#x200B;*Loan.pdf*&#x200B;的PDF文件的不安全PDF文档通过HTTP通过SOAP传递到AEM Forms进程。 PDF文件位于以下URL:`https://[server]:[port]/FormsQS`。 该过程返回一个密码加密的PDF文档，它保存为名为&#x200B;*EncryptedDocument.pdf*&#x200B;的PDF文件。
...
## 快速开始:在。NET项目{#quick-start-invoking-a-service-using-blob-data-over-http-in-a-net-project}中使用BLOB数据通过HTTP调用服务

以下C#代码示例使用HTTP上的数据从Microsoft .NET项目调用名为`MyApplication/EncryptDocument`的进程。 (请参阅[通过HTTP](/help/forms/developing/invoking-aem-forms-using-web.md#invoking-aem-forms-using-blob-data-over-http)使用BLOB数据调用AEM Forms。)

基于名为&#x200B;*Loan.pdf*&#x200B;的PDF文件的不安全PDF文档将使用BLOB通过HTTP传递到AEM Forms进程。 该过程返回一个密码加密的PDF文档，它保存为名为&#x200B;*EncryptedPDF.pdf*&#x200B;的PDF文件。
...
基于名为&#x200B;*loan.pdf*&#x200B;的PDF文件的无担保PDF文档使用MTOM传递到AEM Forms进程。 该过程返回一个密码加密的PDF文档，它保存为名为&#x200B;*EncryptedDocument.pdf*&#x200B;的PDF文件。
...
>[!NOTE]
>
>许多显示如何执行AEM Forms服务操作的快速开始包括MTOM代码示例。
...
基于名为&#x200B;*Loan.pdf*&#x200B;的PDF文件的无担保PDF文档通过SwaRef传递到AEM Forms进程。 加密的PDF文档将保存为名为&#x200B;*EncryptedDocument.pdf*&#x200B;的PDF文件。
