...
以下Java代码示例将名为&#x200B;*Loan.pdf*&#x200B;的PDF文档转换为PDF/A-2b文档，并另存为名为&#x200B;*LoanArchive.pdf*&#x200B;的PDF文件。 (请参阅[将文档转换为PDF/A文档](/help/forms/developing/pdf-a-documents.md#converting-documents-to-pdf-a-documents)。)
