...
>[!NOTE]
>
>有关Rights Management服务的详细信息，请参 [阅AEM Forms服务参考](https://www.adobe.com/go/learn_aemforms_services_63)。
...
在以编程方式执行Rights Management服务操作之前，必须创建Rights Management服务客户端对象。 如果您使用Java API，请创建一个 `DocumentSecurityClient` 对象。 如果您使用Rights ManagementWeb服务API，请创建一个 `DocumentSecurityServiceService` 对象。
