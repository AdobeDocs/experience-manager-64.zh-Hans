...
>[!NOTE]
>
>可以通过更改LESS变量的值来更改标题行和正文行的颜色主题。 有关详细信息，请参阅AEM Forms](/help/forms/using/themes.md)中的[主题。
...
**headersontheleftFigure：左** *侧布局带有标题的表的移动视图*
...
**columnFigure：表** *的折叠列，在移动设备上仅显示两列*

![collapsible_](assets/collapsible_column.png)
**columnFigure：移** *动设备上表的扩展列*
...
要在运行时将这些数据与表合并，我们需要将包含表的自适应表单指向禁用wcmmode的绝对XML位置。 例如，如果自适应表单位于&#x200B;*http://localhost:4502/myForms/bankTransaction.html*，而数据XML文件保存在&#x200B;*C:/myTransactions/bankSummary.xml*，则可以将表与位于以下URL的数据视图:
