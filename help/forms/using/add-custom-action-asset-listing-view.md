...
1. 在apps文件夹中，使用以下步骤创建一个名为items的文件夹，其路径／结构与选择文件夹中的items文件夹类似：
   ...
   1. 右键单击以下路径中的&#x200B;**[!UICONTROL items]**&#x200B;文件夹，然后选择&#x200B;**[!UICONTROL 叠加节点]**:
...
1. 在新创建的项目文件夹下，为特定资产中的自定义按钮／操作添加一个节点(示例：下载FlatPDF)，步骤如下：
   ...
   1. 右键单击&#x200B;**[!UICONTROL items]**&#x200B;文件夹并选择&#x200B;**[!UICONTROL 创建]** > **[!UICONTROL 创建节点]**。
...
1. 在apps文件夹中，使用以下步骤创建一个名为js的文件夹，其路径／结构与管理文件夹中的项目文件夹类似：
   ...
   1. 单击&#x200B;**[!UICONTROL 确定]**。文件夹结构将在应用程序文件夹中创建。 单击&#x200B;**[!UICONTROL 保存全部]**。
...
1. 在以下位置使用命令的操作处理代码创建名为POST.jsp的文件：
   ...
   1. 多次-单击&#x200B;**[!UICONTROL POST.jsp]**&#x200B;文件，以在CRX中打开它。
