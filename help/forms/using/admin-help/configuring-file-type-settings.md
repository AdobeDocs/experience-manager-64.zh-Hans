...
1. 请填写以下部分中的所需信息：
   ...
   要转至其他部分，请单击其网页上的链接，或使用“下一步” **[!UICONTROL 或“]** 上一 **[!UICONTROL 步”按钮]** 。
...
>[!NOTE]
>
>如果选择Acrobat 4.0和更高版本作为目标PDF版本，则拼合所有透明对象。 对于其他目标PDF版本，支持透明度，您可以配置透明度设置。
...
**剪辑复杂区域** -确保矢量图稿和栅格化图稿之间的边界沿对象路径偏移。 此选项可减少在“日志”>的一部分时导致的缝合伪像
...
这些选项决定了Microsoft Excel文件的转换方式。 有关访问这些选项的说明，请参 [阅创建或编辑文件类型设置](#create-or-edit-file-type-settings)。
...
这些选项决定了如何转换Microsoft PowerPoint文件。 有关访问这些选项的说明，请参 [阅创建或编辑文件类型设置](/help/forms/using/admin-help/configuring-file-type-settings.md#create-or-edit-file-type-settings)。
...
这些选项决定如何转换AutoCAD文件。 有关访问这些选项的说明，请参 [阅创建或编辑文件类型设置](/help/forms/using/admin-help/configuring-file-type-settings.md#create-or-edit-file-type-settings)。
...
这些选项决定如何转换OpenOffice文件。 有关访问这些选项的说明，请参 [阅创建或编辑文件类型设置](/help/forms/using/admin-help/configuring-file-type-settings.md#create-or-edit-file-type-settings)。
