...
使用Acrobat，您可以对您在Microsoft Outlook中以电子邮件附件形式发送的文档应用策略。 在Outlook中，您可以使用现有策略或使用Acrobat生成的自动生成策略（使用默认保密设置）来保护文档，该策略适用于附加到电子邮件的文档。 (请参阅* [Acrobat帮助](https://help.adobe.com/en_US/acrobat/pro/using/index.html)*。)
