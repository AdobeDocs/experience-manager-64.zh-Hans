...
AEM Forms应用程序的源代码可通过软件分发提供给客户。 软件分发中的源代码包可以通过以下方式获得： `adobe-aemfd-forms-app-src-pkg-<version>.zip`.
...
AEM Forms应用程序需要AEM Forms服务器。 用户可以在AEM Forms中呈现您创建的表单\
...
有关使用AEM Forms服务器的AEM Forms应用程序的详细信息，请 [参阅refsite文档中的](/help/forms/using/gov-reference-site-walkthrough.md#contard-assessment-task) “Conard获取评估任务”。
...
借助AEM Forms工作流服务器，表单可以与工作台流程和AEM收件箱应用程序中的起点关联。 AEM收件箱应用程序可以具有与其关联的自适应表单。 起点可以具有与其关联的自适应表单、HTML5表单或表单集。 起点可以作为任务提交，或者任务可以另存为草稿。 有关AEM Inbox应用程序与起点之间差异的更多信息，请参 [阅OSGi和AEM FormsJEE工作流上以表单为中心的AEM工作流的操作和功能](/help/forms/using/capabilities-osgi-jee-workflows.md)。
...
AEM Forms应用程序的源代码可从应用程 `adobe-lc-mobileworkspace-src.zip` 序源包中提取，该源代码是软件分发上AEM Forms应用程序源包的一部分。
