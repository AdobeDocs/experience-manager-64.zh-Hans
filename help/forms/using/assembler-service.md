...
Assembler服务允许您合并、重新排列和增强PDF和XDP文档，并获取有关PDF文档的信息。 提交到Assembler服务的每个作业都包括文档描述XML(DDX)文档、源文档和外部资源（字符串和图形）。 有关汇编器服务的详细信息，请参阅[汇编器服务概述](/help/forms/using/overview-aem-document-services.md#p-assembler-service-p)。
...
![一个PDF文档，其中包含位于该文档标题中的唯](do-not-localize/as_batesnumber.png)
**一标** *识符：一个PDF文档，它包含位于该文档标题中的唯一标识符*
...
![将表单片段插入XFA](assets/as_assembler_fragment_assy_assembled.png)
**表单图** *：将表单片段插入XFA表单*
...
![从源文档提取特定页](assets/as_intro_page_extraction.png)
**面图：从** *源文档提取特定页面*
...
![将基于书签的源文档分为多](assets/as_intro_pdfsfrombookmarks.png)
**个文档图：** *将基于书签的源文档分为多个文档*
...
使用DDX和Assembler服务调用其他LiveCycle服务可以简化流程图。 它甚至可以减少自定义工作流所花费的精力。 (另请参阅[以编程方式使用AEM文档服务](https://helpx.adobe.com/experience-manager/6-4/forms/using/aem-document-services-programmatically.html))
