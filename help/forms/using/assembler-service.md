...
通过Assembler服务，您可以合并、重新排列和增强PDF和XDP文档，并获取有关PDF文档的信息。 提交到Assembler服务的每个作业都包括文档描述XML(DDX)文档、源文档和外部资源（字符串和图形）。 有关汇编器服务的详细信息，请参 [阅汇编器服务概述](/help/forms/using/overview-aem-document-services.md#p-assembler-service-p)。
...
![](assets/as_document_assembly.png) 从多个PDF文档汇编一个简单的PDF文档&#x200B;****&#x200B;图：从多 *个PDF文档组合一个简单的PDF文档*
...
![](do-not-localize/as_batesnumber.png) 一个PDF文档，其中包含位于文档标题中的唯一标识符&#x200B;****&#x200B;图：包 *含文档标题中唯一标识符的PDF文档*
...
![](assets/as_assembler_xdpassembly.png) 从多个XDP文档组合一个简单的XDP文档&#x200B;****&#x200B;图：从多 *个XDP文档组合一个简单的XDP文档*
...
![](assets/as_assembler_fragment_assy_assembled.png) 将表单片段插入XFA表单&#x200B;****&#x200B;图：将表 *单片段插入XFA表单*
...
![](assets/as_intro_page_extraction.png) 从源文档提取特定页面&#x200B;****&#x200B;图：从 *源文档提取特定页面*
...
![](assets/as_intro_pdfsfrombookmarks.png) 将基于书签的源文档分为多个文档&#x200B;****&#x200B;图：将基 *于书签的源文档分为多个文档*
...
* 文件附件，包括文件信息。 对于页面级附件，它还包括文件附件注释的位置。 您可以从PDF文档导出此数据，然后将其导入PDF文档。
...
使用DDX和Assembler服务调用其他LiveCycle服务可以简化流程图。 它甚至可以减少您自定义工作流程所花费的精力。 (另请参阅以编 [程方式使用AEM文档服务](https://helpx.adobe.com/experience-manager/6-4/forms/using/aem-document-services-programmatically.html))
