...
![从多个PDF文档组装简单PDF文](assets/as_document_assembly.png)
**档图：** *从多个PDF文档组装简单PDF文档*
...
![包含唯一标识符的PDF文档位于文档标题](do-not-localize/as_batesnumber.png)
**中图：** *包含唯一标识符的PDF文档位于文档标题中*
...
![从多个XDP文档组装简单XDP文](assets/as_assembler_xdpassembly.png)
**档图：** *从多个XDP文档组装简单XDP文档*
...
![将表单片段插入XFA表](assets/as_assembler_fragment_assy_assembled.png)
**单图：** *将表单片段插入XFA表单*
...
![将基于书签的源文档划分为多个文](assets/as_intro_pdfsfrombookmarks.png)
**档图：** *将基于书签的源文档划分为多个文档*
