...
1. 在新创建的节点（此处为afTestRegistration）中指定以下属性值，然后单击&#x200B;**[!UICONTROL 保存全部]**。 这些属性帮助霍布斯将文件夹识别为测试文件。 要将此客户端库作为其他客户端库的依赖关系重复使用，请将其命名为granite.testing.calvin.tests。
...
1. 将以下代码复制到init.js文件，然后单击&#x200B;**[!UICONTROL 保存全部]**:
   ...
   以上代码创建名为&#x200B;**Adaptive Form - Demo Test**&#x200B;的测试套件。 要创建具有不同名称的测试套件，请相应地更改该名称。
...
复选标记图标指示通过的测试：![复选标记](assets/checkmark.png)
