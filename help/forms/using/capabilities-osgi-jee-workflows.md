...
1. 您可以在OSGi上使用以表单为中心的AEM工作流对已填写的自适应表单进行签名。 OSGi上以表单为中心的AEM工作流程支持表单外签名。 不 [支持表单签名](/help/forms/using/working-with-adobe-sign.md#create-in-form-signing-experience) 。
...
1. AEM表单JEE工作流没有Adobe Sign的单独步骤。 您需要为AEM表单JEE工作流程启用Adobe Sign的自适应表单。 有关详细信息，请参 [阅Adobe sign文档](/help/forms/using/working-with-adobe-sign.md#add-and-configure-the-signature-step-component)。
1. 您可以使用“调 [用表单数据模型服务](/help/forms/using/aem-forms-workflow-step-reference.md#p-invoke-form-data-model-service-step-p) ”步骤调用Web服务服务并从第三方应用程序发布或检索数据。
1. 您可以使用“发送电 [子邮件](/help/forms/using/aem-forms-workflow-step-reference.md#send-email-step) ”步骤发送电子邮件。

## AEM收件箱与AEM Forms应用程序功能之间的区别 {#differences-between-aem-inbox-and-aem-forms-app-features}

启动以表单为中心的工作流程的两种主要方法是使用 [AEM收件箱](/help/forms/using/manage-applications-inbox.md) 和AEM Forms应用程序。 但是，AEM收件箱和AEM Forms应用程序的功能不同。 AEM收件箱只能与以表 [单为中心的工作流一起使用](/help/forms/using/aem-forms-workflow.md) ，而AEM Forms应用程序既可以与以表单为中心的工作流一起使用，又可以与流程管理一起使用。
