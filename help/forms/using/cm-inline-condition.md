...
有关详细信息，请参阅在交互通信中的文本 [中以文本创建规则](/help/forms/using/texts-interactive-communications.md)。
...
1. 执行以下操作以构建一个条件，用于评估所选／条件化文本是否显示在字母中，然后点按复选标记以保存表达式：
   ...
   有关创建表达式的详细信息，请参阅在 **Expression builder中使用表达式创建器创建表达式** 和远程 [函数](/help/forms/using/expression-builder.md)。 数据字典中的元素必须支持表达式中指定的值。 有关详细信息，请参 [阅数据字典](/help/forms/using/data-dictionary.md)。
...
1. 预览相关字母，并注意文本会根据内联条件呈现。 您可以使用以下方式输入DD元素“性别”的值：
   ...
   * 附加到相关数据字典的XML数据文件。
   有关详细信息，请参 [阅数据字典](/help/forms/using/data-dictionary.md)。
