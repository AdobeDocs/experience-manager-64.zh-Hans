...
交互式通信可通过两种渠道提供： 印刷和Web。 您还可以创建以打印渠道为主的交互式通信。 Web渠道的打印为主选项可确保Web渠道的内容、继承和数据绑定是从打印渠道派生的。 它还确保在打印渠道中所做的更改在Web渠道中同步。 但是，允许交互通信作者在Web渠道中中断特定组件的继承。
...
1. 在渠道 **向导** :
   ...
   1. 指 **定create_first_ic_print_template** 作为打印模板，然后点按 **选择**。 确保未选 **中“使用打印为Web渠道的主** ”复选框。
...
您还可以通过启用打印和Web渠道之间的自动同步来创建交互式通信。 要启用自动同步，请在创建交互式通信时选择“打印为主页”选项。 选择“打印为主渠道”选项可确保从“打印渠道”派生Web的内容、继承和数据绑定。 它还确保在打印渠道中所做的更改反映在Web渠道中。
...
1. 点按 **编辑** ，以在右窗格中打开交互式通信。
1. 执行“为打印渠道创 [建交互式通信”部分的步骤](#create-interactive-communication-for-print-channel) 6 - 15。
1. 点按左 **侧窗** 格中的渠道选项卡， **然后点按** Web，从打印渠道自动生成Web渠道的内容。
1. 在第4 **步中选中了“将打印作** 为Web渠道的主渠道”复选框，将从“打印”渠道自动为Web生成内容和绑定。
...
1. 重复“为Web渠道创 [建交互式通信](#create-interactive-communication-for-web-channel) ”中的第13 - 18步 **，将“立即** 付费”和“ **订阅** ”超链接插入交互式通信的Web渠道。
