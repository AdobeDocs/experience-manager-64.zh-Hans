...
1. 点按 **编辑** 以在右侧窗格中打开交互式通信。
1. 执行步骤6 - 15(共 [为打印渠道创建交互式通信](#create-interactive-communication-for-print-channel) 中。
...
1. 重复步骤13 - 18，共 [为Web渠道创建交互式通信](#create-interactive-communication-for-web-channel) 插入 **立即付款** 和 **订阅** 超链接。
