...
1. 选择&#x200B;**文件** > **另存为**，将文件保存到本地文件系统上：
   ...
   使用Forms Designer为布局片段创建XDP模板后，必须[将](/help/forms/using/create-templates-print-web.md#upload-xdp-template-to-the-aem-forms-server)上传到AEM Forms服务器，以便该模板在创建布局片段时可用。
