...
1. 选择&#x200B;**文件** > **另存为**&#x200B;以将文件保存到本地文件系统中：
   ...
   使用Forms设计器为布局片段创建XDP模板后，必须[将](/help/forms/using/create-templates-print-web.md#upload-xdp-template-to-the-aem-forms-server)上载到AEM Forms服务器，以便在创建布局片段时可以使用该模板。
