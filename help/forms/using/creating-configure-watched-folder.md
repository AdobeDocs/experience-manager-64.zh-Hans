...
* 已监视文件夹具有各种属性，请参阅[已监视文件夹属性](/help/forms/using/watched-folder-in-aem-forms.md#watchedfolderproperties)。
...
1. 点按&#x200B;**高级**。 高级选项卡包含更多字段。 这些字段中的大多数都包含默认值。
   ...
   * **包括具有模式的文件：** 指定一个分号(;)分隔的模式列表，已监视文件夹使用这些模式确定要扫描和选取的文件夹和文件。例如，如果“Include File Pattern”（包含文件模式）为input&amp;ast;，则所有与input&amp;ast；匹配的文件和文件夹；被捡起。 有关详细信息，请参阅[管理帮助](/help/forms/using/admin-help/configuring-watched-folder-endpoints.md)
