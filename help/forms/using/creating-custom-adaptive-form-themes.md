...
>[!CAUTION]
>
>AEM Forms提供 [主题编辑器](/help/forms/using/themes.md) ，以创建和修改自适应表 [单主题](/help/forms/using/themes.md)。 只有从没有主题编辑器的版本升级，并且已对使用Less/CSS文件( [预主题编辑器方法](/help/forms/using/themes.md) )创建的主题进行了现有投资，才能修改本文中列出的步骤。
