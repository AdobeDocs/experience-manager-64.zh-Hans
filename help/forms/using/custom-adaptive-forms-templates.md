...
* 基本：允许您使用左侧选项卡的布局创建多选项卡自适应表单，您可以按任意顺序访问选项卡。
* 使用Adobe sign进行基本操作：允许您创建包含多个选项卡和向导的表单。 它使用左侧选项卡的布局，允许您按任意顺序访问选项卡。 它使用Adobe Document cloud设计服务进行签名和验证。
...
有关详细信息，请参阅模 [板编辑器](/help/forms/using/template-editor.md)。
