...
>[!NOTE]
>
>We.Finance和We.Gov参考站点均提供员工招聘用例。 演练中使用的示例、图像和说明使用We.Finance参考站点。 但是，您也可以使用We.Gov运行这些用例和检查项目。 为此，请将上述URL中的&#x200B;**we-finance**&#x200B;替换为&#x200B;**we-gov**。
...
#### We Finance Employee Reclouting Post Astivation工作流{#we-finance-employee-recruiting-post-interview-workflow}
...
We.Finance主页和职业页面是AEM Sites页面。 职业页面嵌入一个自适应表单，该表单使用可重复的面板通过服务获取职位空缺并在页面上列表这些空缺。 您可以在`https://[authorHost]:[authorPort]/editor.html/content/forms/af/we-finance/employee/recruitment/jobs.html`查看自适应表单。

### 亲自查看{#see-it-yourself}

转到`https://[publishHost]:[publishPort]/content/we-finance/global/en.html`并单击&#x200B;**[!UICONTROL 职业]**。 单击&#x200B;**[!UICONTROL 搜索]**&#x200B;以填充作业列表，然后单击&#x200B;**[!UICONTROL 应用]**&#x200B;以完成作业。 在表单中填写详细信息并提交申请。

请确保在应用程序中指定有效的电子邮件ID，因为通过此演练的任何通信都将发送到指定的电子邮件ID。

## 约翰·雅各布斯入围了莎拉·罗丝的招聘经理用户档案{#john-jacobs-shortlists-sarah-rose-s-profile-for-the-hiring-manager-s-screening}
...
转到`https://[publishHost]:[publishPort]/content/we-finance/global/en/login.html?resource=/aem/inbox.html`并使用jacobs/password作为John Jacobs的用户名／密码登录。 打开“候选用户档案复查”任务并列出申请人。

## Gloria审阅申请并批准申请人进行{#gloria-reviews-the-application-and-approves-the-applicant-for-an-interview}的面试
...
转到`https://[publishHost]:[publishPort]/content/we-finance/global/en/login.html?resource=/aem/inbox.html`并使用grios/password作为Gloria Rios的用户名／密码登录。 打开“候选人用户档案审阅”任务并单击“计划面试”。
...
## Sarah Rose收到电子邮件，询问计划{#sarah-rose-receives-the-email-with-interview-schedule}
...
## 面试后，招聘经理的入围者莎拉·罗丝{#after-the-interviews-the-hiring-manager-shortlists-sarah-rose}
...
![附加信息1](assets/additionalinformation1.png)
...
## John Doe查看所选候选用户档案，以了解所提供的附加信息{#john-doe-reviews-the-selected-candidate-profile-for-the-additional-information-provided}
...
## John Jacobs收到背景检查请求{#john-jacobs-receives-a-background-check-request}
...
## John Doe向Sarah Rose{#john-doe-sends-out-the-joining-letter-to-sarah-rose}发出加入信
...
![沙拉氏连字符2](assets/sarahrosejoininglettersign2.png)
