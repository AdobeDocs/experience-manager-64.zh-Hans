...
>[!NOTE]
>
>We.Finance和We.Gov参考站点均提供员工自助服务用例。 演练中使用的示例、图像和说明使用We.Finance参考站点。 但是，您也可以使用We.Gov运行这些使用案例和检查对象。 为此，您必须将上述 **URL中的****we-finance替换为we-gov** 。
...
![](assets/we-finance-home.png) we-finance-home图&#x200B;****:组 *织门户*

![](assets/employee-dashboard.png) employee-dashboard ****&#x200B;图：员 *工仪表板*
...
![](assets/conflict-inbox.png) conflict-inbox ****&#x200B;图： *Gloria的收件箱*

![](assets/conflict-approved.png) conflict-approved图&#x200B;****:打 *开任务*
...
![员工自助服务参考站点](assets/employee-self-service-reference-site.png)
...
![](assets/we-finance-home-1.png) we-finance-home-1图&#x200B;****:组 *织门户*

![](assets/employee-dashboard-1.png) employee-dashboard-1 ****&#x200B;图：员 *工仪表板*
...
![](assets/corporate-card-inbox.png) 公司卡收件箱图&#x200B;****: *Gloria的收件箱*

![](assets/corporate-card-approved.png) 公司卡批准&#x200B;****&#x200B;图：打 *开任务*
...
![](assets/we-finance-home-2.png) we-finance-home-2图&#x200B;****:组 *织门户*

![](assets/employee-dashboard-2.png) employee-dashboard-2 ****&#x200B;图：员 *工仪表板*
...
![](assets/expense-report-inbox.png) expense-report-inbox ****&#x200B;图： *Gloria的收件箱*

![](assets/expense-report-approved.png) expense-report-approved图&#x200B;****:打 *开任务*
...
![](assets/we-finance-home-3.png) we-finance-home-3图&#x200B;****:组 *织门户*

![](assets/employee-dashboard-3.png) employee-dashboard-3 ****&#x200B;图：员 *工仪表板*
...
![](assets/leave-inbox.png) leave-inbox ****&#x200B;图： *Gloria的收件箱*

![](assets/leave-approved.png) leave-approved图&#x200B;****:打 *开任务*
