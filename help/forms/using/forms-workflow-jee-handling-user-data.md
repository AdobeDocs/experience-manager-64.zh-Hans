...
description: AEM Forms JEE工作流提供设计、创建和管理业务流程的工具。 了解有关如何访问和删除用户数据的更多信息，在已知工作流发起者或参与者时识别进程实例ID，在将用户数据存储为基元变量时识别进程实例ID，根据进程实例ID从工作流实例中清除用户数据，以及使用孤立任务。
seo-description: AEM Forms JEE工作流提供设计、创建和管理业务流程的工具。 了解有关如何访问和删除用户数据的更多信息，在已知工作流发起者或参与者时识别进程实例ID，在将用户数据存储为基元变量时识别进程实例ID，根据进程实例ID从工作流实例中清除用户数据，以及使用孤立任务。
...
有关创建AEM Forms JEE工作流进程的详细信息，请参阅[Workbench帮助](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/WorkbenchHelp.pdf)。
