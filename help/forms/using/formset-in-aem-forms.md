...
# AEM Forms设置的表单 {#form-set-in-aem-forms}
...
使用 [AEM Forms用户界](/help/forms/using/introduction-managing-forms.md) 面管理您的所有表单、表单集和相关资产。
...
有关AEM Forms应用程序的更多信息，请参阅 [AEM Forms应用](/help/forms/using/aem-forms-app.md)。
