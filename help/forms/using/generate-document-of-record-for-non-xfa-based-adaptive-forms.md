...
1. 在“表单模型”选项卡的“记录模板配置”部分的文档中，选择以下选项之一。
   ...
   **[!UICONTROL 选择此选项可将XDP文件用作定义记录文档的样式和外观的基本模板。选择此选项后，将显示AEM Forms存储库中的所有可用XDP文件。 选择相应的文件。]**

   **选择“Forms模板”作为基本模板以生成记录** 文档选择此选项可将XDP文件用作基本模板，以定义记录文档的样式和外观。选择此选项后，将显示AEM Forms存储库中的所有可用XDP文件。 选择适当的文件。
