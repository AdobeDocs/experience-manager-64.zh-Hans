...
1. 为新用户帐户授予AEM Forms的“在JEE Web内容目录上读取和执行”、“列表文件夹内容”和“读取”权限。
1. 开始应用程序服务器。
...
#### 为JBoss {#configuring-integrated-security-for-sql-server-on-windows-for-jboss}在Windows上的SQL Server配置集成安全性
...
1. 如果请求中没有推荐人，则服务器将检查是否允许Null推荐人:
...
1. 为JEE Web内容目录上的AEM Forms赋予新的用户帐户“读取并执行”、“列表文件夹内容”和“读取”权限。
1. 开始应用程序服务器服务。
