...
* 下载并安装与Workbench集成的Community Help Client <a href="http://www.adobe.com/cn/">所需</a>的最新版Adobe AIR(来自www.adobe.com)。
* Java™ Runtime环境(JRE)6.0更新22或更高版本至6.0新10版 *本（新增）*。
...
### 卸载Acrobat Pro或Acrobat ProExtended附带的Designer {#uninstall-designer-included-with-acrobatpro-or-acrobatextended}

1. 转到 **控制面板>项目>项目和功能**
1. 在“当前安装的项目”列表中，选 **择“Adobe Acrobat Pro** ”或 **“Adobe Acrobat Pro扩展**”。
1. 单击 **更改** ，然后单击 **下一步**。
1. 选择 **修改** ，然后单击 **下一步**。
1. 选 **择Adobe**&#x200B;设计器， **选择此功能将不可用**，然后单击“下 **一步”**
1. 单击 **更新** ，然后单击完 **成**

### 在Windows 10上卸载Acrobat Pro或Acrobat ProExtended附带的设计器 {#uninstall-designer-included-with-acrobatpro-or-acrobatextended-windows10}
...
1. 接受所列的默认目录，或单击选择并导览至要安装Workbench的目录，然后单击下一步。
...
* WST XML [Core org.eclipse.wst.xml_core.feature.feature.group]: 它包含在“Eclipse XML编辑器和工 [具”org.eclipse.wst.xml_ui.feature.feature.group中]
...
1. 按照后续屏幕上的说明将Workbench功能部署到Eclipse。
   ...
   >[!NOTE]
   >
   >用于Flash Builder的AdobeAEM Forms发现插件使您能够快速构建AdobeFlex和AIR应用程序，它们通过AEM Forms的远程端点调用作为其一部分的服务。 有关如何安装和更新插件的信息，请访问Adobe网站，网址为“需要 **链接”**。
...
* **通过引用传递的模板**: 使用内容根和表单名称。 如果使用此方法在每个请求中传递具有不同文件名的唯一模板，磁盘缓存将不断增长，并且永远不会重复使用。 为防止出现这种情况，应使用相同的文件名传递唯一模板，以确保对所有请求更新相同的缓存。
