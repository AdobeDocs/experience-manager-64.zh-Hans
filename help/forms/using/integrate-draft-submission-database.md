...
1. 导航到 `/libs/fd/af/runtime/clientlibs/guideRuntime`并附加 `fp.validation` 值 **嵌入** 属性。

1. 导航到/libs/fd/af/runtime/clientlibs/guideRuntimeWithXFA并附加 `fp.validation` 值 **嵌入** 属性。
