...
1. 导航到 `/libs/fd/af/runtime/clientlibs/guideRuntime`embed属性并 `fp.validation` 将值附 **加到** 。

1. 导航到/libs/fd/af/runtime/clientlibs/guideRuntimeWithXFA并将值附 `fp.validation` 加到 **embed** 属性。
