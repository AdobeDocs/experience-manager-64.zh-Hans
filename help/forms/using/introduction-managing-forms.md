...
* **配置监视文件夹：** 管理员可以配置网络文件夹（称为监视文件夹），以便当用户将文件(如PDF文件)放置在监视文件夹中时，将启动预配置操作并处理该文件。 <!-- Fix broken link For detailed information, see Create and Configure a watched folder. -->
