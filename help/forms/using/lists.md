...
有关将XDP上传／导入到Corresponce Management的说明，请参 [阅将资产导入和导出到AEM Forms](/help/forms/using/import-export-forms-templates.md)。
...
#### 不要在主控页面中使用子表单目标区域 {#do-not-use-subform-target-areas-in-a-master-page}
...
#### 将字段置入主控页面 {#placing-fields-on-master-pages}
