...
如果您是开发人员或站点所有者，则可以自定义Forms Portal(AEM Forms的最终用户界面)，以反映您在组织中使用的元数据。 有关Forms Portal的详细信息，请参阅[在门户上发布表单的简介](/help/forms/using/introduction-publishing-forms.md)。
...
### 对元数据{#extensive-list-of-metadata-nbsp}进行广泛的列表
...
### 导览元数据模式编辑器  {#navigate-the-metadata-schema-editor-nbsp}
...
1. AEM Forms会打开选定资产类型的元数据模式编辑器/表单生成器（在本例中为自适应表单）。
   ...
   [单击可放大](assets/metadata-schema-editor-for-adaptive-form-type.png)
