...
1. 要创建查询，请单击 **添加** (+)。
   ...
   **定义过滤器**
   ...
   1. 要向查询添加其他过滤器，请单击 **Add(+)** 的双曲余切值。

      要从查询中删除过滤器，请单击 **Delete(-)** 的双曲余切值。
...
1. 执行进程/任务搜索。 有关详细信息，请参阅 [执行进程搜索查询](/help/forms/using/process-reporting/adhoc-queries-in-process-reporting.md#p-to-execute-a-search-query-p).
