...
1. 导航到 **Home** > Services **> Applications** and Services > ************ Service Management进程和Home Management processDataStorageProviderServiceServices服务。
...
1. 导航到“ **主页** ”>“服务 **”** >“应用程序和 **服务”>“应用程序和服务** ”>“开放管理和 ******** Publisher Service service数据”。
...
有关预定义报表的详细信息，请参 [阅Pre-defined Reporting in Process](pre-defined-reports-in-process-reporting.md)。

**** 临时查询：此项目包含对进程和任务执行基于筛选器的搜索的选项。

有关专门查询的详细信息，请参 [阅进程报告中的专门查询](adhoc-queries-in-process-reporting.md)。
