...
您可以使用文档安全性将特定PDF文档的访问权限限制为仅限授权用户。 您还可以确定收件人如何使用受保护的文档。 例如，您可以指定收件人是否可以打印、复制或编辑受文档安全策略保护的文档的文本。 要进一步了解文档安全，请参 [阅文档安全](/help/forms/using/admin-help/document-security.md)。

您可以使用阅读器扩展在Adobe PDF文档通过Acrobat Reader启用交互功能。 这些交互功能通常仅通过Adobe Acrobat专业版和标准版提供。 要了解Reader扩展可以启用的交互功能，请参阅 [Adobe Experience Manager Forms文档保障服务](/help/forms/using/overview-aem-document-services.md)**。**
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>指定表示要从中删除使用权限的<br /> PDF文档的InputStream。 您可以使用LiveCycleRights Management或AEM Forms文档安全保护文档。</td> 
  </tr> 
 </tbody> 
</table>
