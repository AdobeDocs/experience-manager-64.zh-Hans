...
* **[decode](https://helpx.adobe.com/experience-manager/6-4/forms/javadocs/com/adobe/fd/bcf/api/BarcodedFormsService.html#decode)**:解码输入PDF文档或tiff图像中所有可用的条形码。它会返回另一个XML文档，其中包含从输入文档或图像中所有可用的条形码检索到的数据。
