...
### 对JSP或Servlet使用toImage API {#using-toimage-api-with-a-jsp-or-servlets}
...
唯一的区别是从JSP/Servlet运行服务，文档对象从ResourceResolverHelper对象中自动检索ResourceResolver对象的实例。 这种自动机构\
当从工作流调用代码时，不工作。 对于工作流，将ResourceResolver对象的一个实例显式传递给Document类构造函数。 然后，Document对象使用\
