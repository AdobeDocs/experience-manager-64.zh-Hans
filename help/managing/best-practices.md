...
* 文档直接基于核对 [清单](/help/managing/best-practices-checklist.md)，详细介绍了：
   ...
   * [项目心跳](#project-heartbeat-dashboard) 分析。
...
* **阶段完整性**
   ...
   * 在项目期间的任何时间点，它都表示已经为项目的每个阶段完成了多少。

## 按角色列出的状态 {#status-by-role}

按角 **色列出的** “状态”工作表按阶段和人物 **[显示“运行状况](#project-heartbeat-dashboard)**、质量和完**[&#x200B;整性”的](#phases-and-milestones)****[](#persona)**详细细目。
