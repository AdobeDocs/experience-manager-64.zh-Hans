...
+ 创作On-Demand services应用程序 {#authoring}
   ...
   + [AEM Mobile应用程序控制板](mobile-apps-ondemand-application-dashboard.md)
...
+ 开发Adobe phoneGap Enterprise {#developphonegap}
   ...
   + [在AEM中开发Mobile应用程序](developing-mobile-applications.md)
   + [内容同步的移动设备](phonegap-contentsync.md)
   + [应用程序剖析](phonegap-apps-arch.md)
   + [使用PhoneGap CLI开发应用程序](phonegap-apps-pg-cli.md)
   + [开箱即用的应用程序处理程序](contentsync-app-handlers.md)
   + [使用应用程序控制台创建和编辑应用程序](phonegap-apps-console.md)
   ...
   + [配置Adobe Target云服务](aem-mobile-configuring-cloud-service.md)
...
+ 管理Adobe phoneGap Enterprise {#administering-phonegap}
   ...
   + [配置Adobe PhoneGap Build云服务](configure-phonegap-build-cloud.md)
   + [将引用过滤器设置为允许空](setting-referrer-filter-empty.md)
   + [配置Adobe Mobile Services Cloud服务](configure-adobe-mobile-cloud-service.md)
