...
title: 移动应用程序
seo-title: 移动应用程序
description: 此页面用作开始创作、开发和管理移动应用程序的登录页面。
seo-description: 此页面用作开始创作、开发和管理移动应用程序的登录页面。
...
* [AEM Mobile点播服务入门](/help/mobile/aem-mobile-on-demand.md)
* [使用AEM的Adobe phoneGap Enterprise快速入门](/help/mobile/developing-in-phonegap.md)
