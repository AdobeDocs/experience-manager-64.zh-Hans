---
title: AEM 6.4 Mobile用户指南
seo-title: AEM 6.4 Mobile用户指南
description: 本指南介绍如何为移动应用程序创建和管理内容。
seo-description: 介绍如何为移动应用程序创建和管理内容。
...
本指南涵盖所有AEM Mobile任务，如如何为移动应用程序创建和管理内容。
