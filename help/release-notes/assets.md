...
Adobe企业Creative Cloud中的资产链接简化了内容创建过程中创意人员与营销人员之间的协作。 它是企业Creative Cloud的新本机功能，可直接与Adobe Photoshop、Adobe Illustrator或Adobe InDesign的AEM Assets建立连接，无需离开这些工具。

要进一步了解功能、先决条件以及如何访问它，请参阅 [Adobe资产链接](https://helpx.adobe.com/cn/enterprise/using/adobe-asset-link.html) 。
...
要使用AEM Assets增强智能标记，请 [安装最新的AEM 6.4服务包](https://helpx.adobe.com/cn/experience-manager/aem-releases-updates.html)。
...
* 改进了用户体验，与“模板”用户界面保持一致。 有关详细信息，请参 [阅Catalog Producer](../sites-administering/catalog-producer.md)。
...
有关受支持平台的概述，请参阅技 [术要求文档](../sites-deploying/technical-requirements.md)。
...
6.4中的Dynamic Media支持新模式-主控资产通过AEM Assetsweb UI上传和管理，动态演绎版和其他动态媒体功能由Dynamic Media云投放服务在后台处理。

在此模式(首先随AEM 6.3功能包14410和 [18912推出](https://helpx.adobe.com/experience-manager/6-3/release-notes/dynamic-media-featurepack-14410.html))中，用户可以使用现代AEM AssetsWeb UI从端到端资产管理和动态媒体功能受益，同时仍然利用与Dynamic Media经典(Scene7)向后兼容的投放服务，包括投放URL，这些URL保持不变。

此外，AEM 6.4引入了以Adobe Sensei为后盾的新增功能、对VR和3D等新兴媒体的增强、Dynamic Media查看器以及交互式图像和旋转横幅中的体验片段支持。
...
请参 [阅图像用户档案](../assets/image-profiles.md) 文档以了解更多信息。

另请参 [阅将Dynamic Media资产添加到页面文档](../assets/adding-dynamic-media-assets-to-pages.md) ，进一步了解如何将智能裁剪与Dynamic Media组件结合使用。
...
* 全景查看器有助于吸引用户，并提供更好地体验会议室场景、属性、位置和风景的能力。 请参 [阅全景图](../assets/panoramic-images.md) 文档以了解相关信息。

* VR查看器为属性、位置和风景提供身临其境的体验。
* 为产品图像优化的垂直图像查看器。
* 键盘辅助功能改进。

### 3D以及与DimensionCC的集成 {#d-and-integration-with-dimension-cc}

现已引 [入与](https://www.adobe.com/products/dimension.html) Adobe Dimension CC的集成，实现更无缝的3D工作流程。 要了解更多信息，请参 [阅使用3D资产文档](../assets/assets-3d.md) 。
