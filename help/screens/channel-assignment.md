...
* [配置和部署 Screens](/help/screens/configuring-screens-introduction.md)
* [创建和管理Screens项目](/help/screens/creating-a-screens-project.md)
* [创建和管理渠道](/help/screens/managing-channels.md)
* [创建和管理位置](/help/screens/managing-locations.md)
* [创建和管理显示屏](/help/screens/managing-displays.md)

## 分配渠道 {#assign-a-channel}

请按照以下步骤为显示屏分配渠道：

1. 导航到所需的显示屏，例如， **DemoProject** >位 **置** > **SanJose** > **** StoreDisplayStoreDisplay。
