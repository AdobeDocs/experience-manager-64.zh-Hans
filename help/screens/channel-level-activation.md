...
* **[概述](/help/screens/channel-level-activation.md#overview)**
* **[将频道级别激活用作单个事件回放](/help/screens/channel-level-activation.md#using-channel-level-activation)**

   * **[前提条件](/help/screens/channel-level-activation.md#prerequisites)**
   * **[实施](/help/screens/channel-level-activation.md#implementation)**

* **[查看结果](/help/screens/channel-level-activation.md#viewing-the-results)**
...
1. **分配要显示的渠道**
   ...
   1. 将“优 **先级** ”设置为 **2**。
   1. 选择“ **Supported Events** ”(支持的事 **件**)，如“Initial Load **”（初始负载）、“Idle Screen** Timer *****”（空闲屏幕）和“Timer*”（计时器*），如下图所示。
   1. 选择有效日 **期** ，从2018年11月27日晚11:59开始， **到2018年11月** 28日上午12:05。**
   1. Click **Save**.*
*
   >[!CAUTION]
