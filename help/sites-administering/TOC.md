...
+ 安全性 {#security}
   ...
   + [用户同步](sync.md)
   + [封装令牌支持](encapsulated-token.md)
   + [单点登录](https://experienceleague.adobe.com/docs/experience-manager-64/deploying/configuring/single-sign-on.html)
   ...
   + [安装时配置管理员密码](security-configure-admin-password.md)
   + [AEM中的服务用户](security-service-users.md)
   + [对配置属性的加密支持](encryption-support-for-configuration-properties.md)
   + [处理AEM Foundation的GDPR请求](handling-gdpr-requests-for-aem-platform.md)
...
+ 个性化 {#personalization}
   ...
   + [将Landing Pages与Adobe Analytics集成](integrating-landing-pages-with-adobe-analytics.md)
+ 电子商务 {#ecommerce}
   + [电子商务](ecommerce.md)
   + [概念](concepts.md)
   + [管理通用电子商务](generic.md)
...
+ 集成 {#integration}
   ...
   + [连接到Adobe Analytics并创建框架](adobeanalytics-connect.md)
   ...
   + [AEM Portals和Portlet](aem-as-portal.md)
   ...
   + [Target与体验片段的集成](experience-fragments-target.md)
+ 最佳实践 {#bestpractices}
   ...
   + [处理AEM Foundation的GDPR请求](https://experienceleague.adobe.com/docs/experience-manager-64/administering/security/handling-gdpr-requests-for-aem-platform.html)
   + [AEM Commerce - GDPR准备工作](https://experienceleague.adobe.com/docs/experience-manager-64/administering/ecommerce/gdpr-compliance-commerce.html)
+ 内容管理 {#contentmanagement}
   ...
   + [屏幕内容管理](content-management-screens.md)
