...
将网页与框架关联时，框架将对该页面和该页面的后代执行跟踪。 页面视图随后可从Adobe Analytics检索并显示在站点控制台中。
...
在继续操作之前，请确保凭据允许您使用以下任一方法登录AdobeAnalytics:
...
2. 滚动到 **AdobeAnalytics** ，单 **[击“可]** 用配置” **旁边的+**。
...
* **跟踪服务器**
   ...
   * 包含用于发送AdobeAnalytics呼叫的URL
      ...
      * cname —— 默认为AdobeAnalytics帐户的*公司名称*
...
有关更 [多详细信息，请参](/help/sites-authoring/pa-using.md) 阅查看页面Analytics数据。
