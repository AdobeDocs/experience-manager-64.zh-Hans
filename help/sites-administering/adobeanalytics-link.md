...
请执行以下过程来了解Adobe Analytics集成的链接跟踪行为。 过程显示来自[Adobe Experience Cloud调试器](https://docs.adobe.com/content/help/en/debugger/using/experience-cloud-debugger.html)的结果。
