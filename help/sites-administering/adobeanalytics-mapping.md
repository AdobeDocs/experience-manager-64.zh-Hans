...
1. 要使框架在站点的发布实例上可用，请打开Sidekick的**页面**选项卡，然后单击“激 **活框架”。**
...
1. 在Adobe Analytics视图中时，内容查找器会显示属于在CQ视图中拖动的跟踪组件的所有CQ变量。
   ...
   * 例如，如果**下载组件**是CQ视图中仅拖动的一个 *(它有两个可映射的变量* eventdata.downloadLink *和* eventdata.events.startDownload **)，则切换到Adobe Analytics视图时，内容查找器将如下所示：
