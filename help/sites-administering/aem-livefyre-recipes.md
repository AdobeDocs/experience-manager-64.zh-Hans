...
Livefyre Adobe Experience Manager包适用于AEM 6.1、6.2 SP1、6.3、6.4和6.4 SP1。 不支持AEM 5.x和6.0。 有关详细说明，请参阅 [与Livefyre集成](/help/sites-administering/livefyre.md).

要了解支持哪些Livefyre应用程序，请参阅 [AEM Livefyre应用程序支持列表](/help/sites-administering/livefyre.md#aem-support-matrix-for-livefyre-apps).
...
1. [配置流和添加规则以将UGC策划到Livefyre资产库文件夹](https://experienceleague.adobe.com/docs/livefyre/using/streams/c-streams.html).
...
1. [在Livefyre Asset Library文件夹中收集、组织和管理策划的UGC](https://experienceleague.adobe.com/docs/livefyre/using/library/assets/c-assets.html).
...
1. [使用Livefyre Studio请求针对策划的UGC的权限](https://experienceleague.adobe.com/docs/livefyre/using/rights-requests/c-how-requesting-rights-works.html).

**AEM设置(用于将UGC导入AEM Assets):**

1. [快速入门](/help/sites-administering/livefyre.md#getting-started)
1. [配置AEM以使用Livefyre](/help/sites-administering/livefyre.md#configure-aem-to-use-livefyre-create-a-configuration-folder)
1. [将由Livefyre策划的UGC导入AEM Assets](/help/sites-administering/livefyre.md#use-livefyre-with-aem-assets)
