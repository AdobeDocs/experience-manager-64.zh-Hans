...
>[!NOTE]
>
>Client Context已被ContextHub取代。 有关更多详细信息，请参阅相关的[配置](/help/sites-administering/contexthub-config.md)和[developer](/help/sites-developing/contexthub.md)文档。
...
* ****
编辑将打开一个新页面，允许您 [编辑、添加或删除配置文件属性](#editing-property-details)。
...
编辑客户端上下文可用于设置（或重置）某些属性的值。 这允许您测试特定方案（对于[segmentation](/help/sites-administering/campaign-segmentation.md)和[促销活动](/help/sites-authoring/personalization.md)特别有用）。
