...
>[!NOTE]
>
>Client Context已被ContextHub取代。 有关详细信息，请参阅相关 [配置](/help/sites-administering/contexthub-config.md) 和开 [发人员](/help/sites-developing/contexthub.md) 文档。
...
* **编辑**&#x200B;此时将打开一个新页面，您 [可以编辑、添加或删除用户档案属性](#editing-property-details)。
...
编辑Client Context可用于设置（或重置）某些属性的值。 这允许您测试特定方案(对分段和 [活动](/help/sites-administering/campaign-segmentation.md) 尤 [为有用](/help/sites-authoring/personalization.md))。
