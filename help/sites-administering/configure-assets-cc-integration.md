...
>[!NOTE]
>
>AEM到Adobe Creative Cloud文件夹共享功能已弃用。 了解更多信息，在[AEM和Creative Cloud集成最佳实践](../assets/aem-cc-integration-best-practices.md)中找到更好的方法。 不弃用AEM到Marketing Cloud复制以及在AEM Assets和Marketing Cloud之间交换资产的配置。
...
1. 找到&#x200B;**[!UICONTROL Adobe Marketing Cloud]**&#x200B;服务。 如果不存在配置，请单击&#x200B;**[!UICONTROL Configure Now]**。 如果存在配置，请单击&#x200B;**[!UICONTROL 显示配置]**，然后单击&#x200B;**[!UICONTROL [+]]**&#x200B;添加新配置。
...
1. 在&#x200B;**[!UICONTROL 租户URL]**&#x200B;字段中，指定AEM Assets的URL。
   ...
   >[!CAUTION]
   >
   >由于重新设定品牌，如果您将租户URL输入为&#x200B;**https://&lt;tenant_id>.marketing.adobe.com**，则需要将其更改为&#x200B;**https://&lt;tenant_id>.experiencloud.adobe.com。** 为此，请按照以下步骤操作：
   1. 导航到&#x200B;**工具 > 云服务 > 旧版云服务**。
