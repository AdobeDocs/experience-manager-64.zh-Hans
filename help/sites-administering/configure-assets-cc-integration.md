...
>[!NOTE]
>
>此功能已在AEM Assets中弃用。 在 [AEM和Creative Cloud集成最佳实践](/help/assets/aem-cc-integration-best-practices.md). 如果你有任何疑问， [联系Adobe客户支持](https://www.adobe.com/cn/account/sign-in.supportportal.html).
...
1. 选择文件夹并单击 **共享** ![assets_share](assets/assets_share.png).
