...
>[!NOTE]
>
>已弃用AEM到Adobe Creative cloud文件夹共享功能。 了解更多信息，并查找 [AEM和Creative cloud集成最佳实践中的更佳方法](../assets/aem-cc-integration-best-practices.md)。 AEM到Marketing cloud的复制配置以及AEM资产与Marketing cloud之间的资产交换配置未弃用。

![集成AEM资产和Creative cloud时的数据流](assets/chlimage_1-287.png)
...
>[!CAUTION]
>
>Adobe Maketing cloud已更名为Adobe Experience Cloud。 下面的步骤仍然提到Marketing Cloud，以反映当前的界面。
...
1. 单击&#x200B;**[!UICONTROL 创建]**。系统会显示一条消息，通知已创建应用程序。
   ...
   ![成功创建应用程序以将AEM资产与Adobe CC集成的通知](assets/chlimage_1-289.png)
...
1. 在“创 **[!UICONTROL 建配置]** ”对话框中，指定新配置的标题和名称，然后单击“创 **[!UICONTROL 建”]**。
   ...
   ![为新配置命名以集成AEM Assets和CC](assets/cloudservices_configure_mc.png)

1. 在租 **[!UICONTROL 户URL字段]** ，指定AEM资产的URL。

   >[!CAUTION]
   >
   >由于需要重新设定品牌，如果您将租户URL输入为 **https://&lt;tenant_id>.marketing.adobe.com** ，则需要将其更改为 **https://&lt;tenant_id>.experiencecloud.adobe.com。** 为此，请按照以下步骤操作：
   1. 导航到&#x200B;**工具 > 云服务 > 旧版云服务**。
...
1. 在对话框中，单击“ **[!UICONTROL 测试连接”]**。
   ...
   ![测试连接并设置组织的默认复制配置文件](assets/chlimage_1-294.png)
...
1. 从边栏中，转到**[!UICONTROL Administration]**，然后单击／点按启 **[!UICONTROL 动Enterprise Dashboard]**。
...
>[!MORELIKETHIS]
* [AEM与Creative cloud集成最佳实践](../assets/aem-cc-integration-best-practices.md)
