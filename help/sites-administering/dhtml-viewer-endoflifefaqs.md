...
description: 自2014年1月31日起，DHTML查看器平台将正式终止生命周期。
...
请参阅 [Dynamic Media查看器参考指南](https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/library/homeviewers.html) ，以了解最新支持的查看器。
