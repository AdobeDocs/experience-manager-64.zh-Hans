...
1. 指定：
   ...
   * **导入程序**
      ...
      特定 [商务提供商](/help/sites-administering/concepts.md#commerce-providers)，默认情况下 `Geometrixx`.
...
1. 指定：
   ...
   * **商业提供程序**
      ...
      导入程序 [商务提供商](/help/sites-administering/concepts.md#commerce-providers);默认Geometrixx。
...
1. 随即会打开向导。 使用 **基本** 和 **产品选项卡** 输入 [产品属性](/help/sites-administering/concepts.md#product-attributes) （对于新产品或产品变体）。
...
>
>这表示默认情况下，它们将被 [dispatcher](https://helpx.adobe.com/cn/experience-manager/dispatcher/using/dispatcher-configuration.html)，以根据需要进行配置。
...
1. 的 [产品属性](/help/sites-administering/concepts.md#product-attributes) 中。 使用 **编辑** 和 **完成** 进行任何更改。
...
1. 切换到 [预览](/help/sites-authoring/editing-content.md#previewing-pages) 模式。
...
>[!NOTE]
>
>以下示例涉及直接在 [营销活动](/help/sites-authoring/personalization.md)，用于凭证。
>
>促销活动也可以位于 [体验](/help/sites-authoring/personalization.md) 在营销策划中。
>
>有关详细信息，请参阅 [促销和凭单](#promotions).
...
1. 随即会打开向导。 使用 **基本**, **内容**, **付款** 和 **履行** 选项卡 [有关新订单的信息](/help/sites-administering/concepts.md#order-information).
...
1. 的 [订单信息](/help/sites-administering/concepts.md#order-information) 中。 使用 **编辑** 和 **完成** 进行任何更改。
