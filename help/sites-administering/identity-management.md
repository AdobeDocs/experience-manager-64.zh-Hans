...
>[!NOTE]
>
>配置文件中指定的信息还可用于通过“区段”和“营销活动”为用户提供 [目标](/help/sites-administering/campaign-segmentation.md)[内容](/help/sites-authoring/personalization.md)。

## 注册表单 {#registration-forms}

表单可用于收集注册信息，然后生成新帐户和配置文件。
...
/home每个人都允许jcr:read rep:glob = &amp;ast;/profile&amp;ast;
