...
>
>要阅读使用Apache DS配置Experience Manager的示例，请参阅[将Adobe Experience Manager6.4配置为使用Apache Directory Service。](https://helpx.adobe.com/experience-manager/using/configuring-aem64-apache-directory-service.html)
