...
description: 了解如何将Livefyre的行业领先特选功能与AEM 6.4实例集成，使您能在几分钟内将宝贵的用户生成内容(UGC)从社交网络发布到您的站点。
...
了解如何将Livefyre的行业领先特选功能与AEM 6.4实例集成，使您能在几分钟内将宝贵的用户生成内容(UGC)从社交网络发布到您的站点。
...
1. 在功能包信息页面上，单击“ **下载**”，然后阅读“包许可协议”并单击“接 **受”**。
