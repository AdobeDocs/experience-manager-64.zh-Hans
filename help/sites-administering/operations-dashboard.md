...
有关为AEM 6.4执行修订清理的详细信息，请[参阅此专述文章](/help/sites-deploying/revision-cleanup.md)。
...
>[!NOTE]
>
>有关工作流维护的详细信息，请参阅[此页面](workflows-administering.md#regular-purging-of-workflow-instances)。
