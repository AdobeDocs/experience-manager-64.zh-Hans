...
1. 如果希望AEM资产自动上传到Dynamic Media经典，您需要打开此选项，并将Dynamic Media经典添加到DAM更新资产工作流。 您还可以手动上传资产。
...
1. 导航回AEM欢迎页面，然后点按&#x200B;**[!UICONTROL 工作流]**。 多次-单击&#x200B;**DAM更新资产**&#x200B;工作流以打开它。
1. 在Sidekick中，导航到&#x200B;**[!UICONTROL Workflow]**&#x200B;组件，然后选择&#x200B;**[!UICONTROL Dynamic Media经典]**。 将&#x200B;**[!UICONTROL Dynamic Media经典]**&#x200B;拖到工作流中，然后点按&#x200B;**[!UICONTROL 保存]**。 添加到“AEM Assets”文件夹中的资产将自动上传到“Dynamic Media经典”。
...
您可以通过导航到AEM中页面上的Dynamic Media经典组件并点按&#x200B;**[!UICONTROL 编辑]**&#x200B;来选中此选项。 资产的URL中将列出安全预览服务器。 在AEM中发布后，文件引用中的服务器域将从预览URL更新到生产URL。
...
1. 点按AEM图标，然后导航到&#x200B;**[!UICONTROL 工具>操作> Web Console]**。
...
* 检查您尝试上传的资产是否位于&#x200B;**[!UICONTROL CQ目标]**&#x200B;文件夹中(您在Dynamic Media经典云配置中指定此文件夹)。
...
* 确保已通过&#x200B;**[!UICONTROL 页面属性]**&#x200B;配置该页面的云配置。 视频预设在Dynamic Media经典视频组件中可用。
