...
当整个语句的计算结果为true时，段即已解析。 在适用多个区段的事件中，还 **会使** 用提升因子。 有关 [提升因子的详细信息](#creating-a-new-segment) ，请参阅创 [建新区段。](/help/sites-administering/campaign-segmentation.md#boost-factor)
...
>
>因此， [在创建区段](/help/sites-administering/segmentation.md#creating-a-new-segment)时，只要已知比较值 **的类型** ，就应选择数据类型。 例如：
>
