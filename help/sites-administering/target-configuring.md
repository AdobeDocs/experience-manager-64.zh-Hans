...
要找到云和框架，请通过“工具” **>“部** 署” **>“云配置”导航**********&#x200B;到云服务。 ([http://localhost:4502/libs/cq/core/content/tools/cloudservices.html](http://localhost:4502/libs/cq/core/content/tools/cloudservices.html))\
在Adobe Target下，单击或点按显 **示配置**。
...
1. 单击 **连接到Target** ，以初始化与Target的连接。 如果连接成功，则显示消息**连接成功**。 单 **击消息** “确定”，然后 **单击** “确定”。
