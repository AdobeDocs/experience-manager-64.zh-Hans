...
1. 单击&#x200B;**连接到Target**&#x200B;以初始化与Target的连接。 如果连接成功，则会显示“**连接成功**”消息。 在消息上单击&#x200B;**OK**，然后在对话框上单击&#x200B;**OK**。
...
配置Target云配置后，添加Target框架。 该框架标识从可用的[Client Context](/help/sites-administering/client-context.md)或[ContextHub](/help/sites-administering/contexthub-config.md)组件发送到Adobe Target的默认参数。 Target使用参数来确定应用于当前上下文的区段。
...
1. 在“创建框架”对话框中，指定&#x200B;**标题**，选择&#x200B;**Adobe Target框架**，然后单击&#x200B;**创建**。
   ...
   将打开框架页面。 Sidekick提供的组件表示您可以映射的[Client Context](/help/sites-administering/client-context.md)或[ContextHub](/help/sites-administering/contexthub-config.md)中的信息。
