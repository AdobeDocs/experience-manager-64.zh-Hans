...
>[!NOTE]
>
>升级到6.4后，建议将文件从/etc移动。 有关详细信息，请参阅AEM 6.4](/help/sites-deploying/all-repository-restructuring-in-aem-6-4.md#translation-rules)中的[公共存储库重组。
...
在编辑器中，可以选中／取消选中&#x200B;**过滤器**&#x200B;选项卡中的&#x200B;**I`s Deep`**。
