...
>[!NOTE]
>
>升级到6.4后，建议将文件从/etc移动。 有关更 [多详细信息，请参阅AEM 6.4中的常见存储库重组](/help/sites-deploying/all-repository-restructuring-in-aem-6-4.md#translation-rules) 。
...
在编辑器中，您可以在“过滤器”选项卡中选 **中`s Deep`**/取消选中**“I **”。
