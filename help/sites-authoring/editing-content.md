...
1. 所选组件将添加到页面底部。 [编辑](#edit-content) 组件（根据需要）。
...
如果您在浏览资产时发现需要对某个资产进行快速更改，则可以启动 [资产编辑器](/help/assets/managing-assets-touch-ui.md) 单击资产名称旁边的编辑图标，可直接从浏览器访问。
...
* [拖放资产](#inserting-a-component-using-the-assets-browser) ，以直接添加内容。
