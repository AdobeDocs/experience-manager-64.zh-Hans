...
This structure can be viewed From the **Sites** console, where you can [navigate through the pages of your website](/help/sites-authoring/basic-handling.md#product-navigation) and perform actions on the pages. 您还可以创建新站点和[新页面](#creating-a-new-page)。
...
如果您在创建新页面时仅提供页面&#x200B;**标题**，则 AEM 将从此字符串派生页面&#x200B;**名称**[，并根据 AEM 和 JCR 实行的约定验证该名称。](/help/sites-developing/naming-conventions.md)A **Title** field containing invalid characters will be accepted, but the name derived will have the invalid characters substituted. 例如：
...
1. 导航到要创建新页面的位置。
1. 使用工具栏中的创 **建** ，打开下拉选择器，然后从列 **表中选择页** 面：
