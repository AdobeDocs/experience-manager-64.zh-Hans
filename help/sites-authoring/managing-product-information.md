...
1. 点按/单击&#x200B;**修饰照片拍摄**&#x200B;页面中的&#x200B;**查看已上传的资产**&#x200B;链接，以浏览已上传的图像。
...
1. 在&#x200B;**审核并批准**&#x200B;页面中，将审核任务分配给角色（例如“审阅人”），然后点按/单击**审核**以开始审核上传的产品图像。
...
1. 现在，在[移动到生产任务](#move-to-production-task)完成并分配给所有者后，即会出现新的项目所有者接受任务。
