...
>
>请参阅 [CQ小组件API中的SiteAdmin](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.SiteAdmin) 以了解更多详细信息。
