...
使用Apache Felix Web管理控制台（例如，在`http://localhost:4502/system/console/configMgr`）可以更改范围。 选择`CQ WCM Find Replace Servlet (com.day.cq.wcm.core.impl.servlets.FindReplaceServlet)`并根据需要配置范围。
