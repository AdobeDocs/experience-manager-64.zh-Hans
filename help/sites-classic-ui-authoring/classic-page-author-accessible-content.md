...
![经典 UI 中图像组件的编辑对话框；显示“替换文本”字段。](assets/chlimage_1-17.png)
...
* 图表和图形：
   ...
   ![图形示例。下面是提供替代文本的最佳方法。](assets/chlimage_1-2.jpeg)
...
![在源代码编辑模式中显示的“段落”元素示例（经典 UI）。](assets/chlimage_1-18.png)
...
* **使用标题：**
   ...
   ![下拉选择器中显示的 H1 至 H3 级别的标题（经典 UI）。](assets/chlimage_1-19.png)
...
* **使用表**：
   ...
   * 理想情况下，请删除 **Width**、 **Height**、Border **、** Border Border Sell PaddingSpacing **、****** Cell Spacing的默认值。 因为这些属性可以在全局样式表中设置。
   ![“表属性”对话框。](assets/chlimage_1-20.png)

   然后，可以在&#x200B;**单元格属性**&#x200B;中选择该单元格是数据单元格还是标题单元格；如果是标题单元格，再选择该单元格与行或列相关还是与两者都相关：

   ![调用属性对话框；将某个行（通常是首行）设置为标题行。](assets/chlimage_1-21.png)
...
![“标题与文本”选项卡（编辑对话框）；已添加标题“描述”。](assets/chlimage_1-22.png)
...
![在“标题”字段（编辑对话框）中设置了替换文本的图像按钮。](assets/chlimage_1-23.png)
...
![向单选按钮组添加项目。组标题是“我的联系方式”- 在“标题”字段中定义。](assets/chlimage_1-24.png)
...
![在“标题”字段中为屏幕阅读器用户添加其他信息（“必填”一词）。](assets/chlimage_1-25.png)
