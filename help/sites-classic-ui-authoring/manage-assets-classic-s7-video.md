...
1. 在Dynamic Media Classic中，设 [置到Dynamic Media Classic（系统自动）的计划FTP上传和编码](https://help.adobe.com/en_US/scene7/using/WS70B173EC-4CAD-4b4c-BF9C-43A11F3A5950.html)。
...
即使建议使用Dynamic Media Classic视频组件观看Dynamic Media Classic视频，为了实现完整性，本节也会介绍将Dynamic Media Classic视 [!UICONTROL 频与AEM的] Foundation Video组件一起使用。
