...
有关如何使用Amazon Web services设置MongoDB的文档，请查阅以下AWS上的 [MongoDB指南](https://docs.aws.amazon.com/quickstart/latest/mongodb/welcome.html)。
...
为了正确提供MongoDB部署，将托管调度程序的操作系统必须运行 **Apache httpd版本2.4或更高版本。**
