...
seo-description: 了解如何进行必要的更改，以便迁移到AEM 6.4中新的存储库结构，该结构对于AEM的所有区域都是通用的。
...
如AEM 6.4](/help/sites-deploying/repository-restructuring.md)中的父[存储库重组页面中所述，升级到AEM 6.4的客户应使用此页面评估与存储库更改相关的工作量，这些工作量可能会影响所有解决方案。 某些更改在AEM 6.4升级过程中需要工作，而其他更改可能会推迟到6.5升级。
