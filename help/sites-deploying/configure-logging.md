...
>[!NOTE]
>
>登录AEM基于Sling原则。 有关详细信息，请参阅[Sling日志记录](https://sling.apache.org/site/logging.html)。

## 全局日志记录{#global-logging}

[Apache Sling Logging ](/help/sites-deploying/osgi-configuration-settings.md) Configuration用于配置根记录器。这定义了登录AEM的全局设置：
...
>[!NOTE]
>
>此[知识库文章](https://helpx.adobe.com/experience-manager/kb/HowToRotateRequestAndAccessLog.html)介绍如何旋转request.log和access.log文件。

## 个人服务的记录者和作者{#loggers-and-writers-for-individual-services}
...
(org.apache.sling.commons.log.LogManager.factory.config.649d51b7-6425-45c9-81e6-2697a03d6be7)
   ...
   * 将`Warning`消息写入服务`org.apache.pdfbox`的`../logs/error.log`。

* 不链接到特定写入程序，因此将创建并使用具有默认配置（每日日志旋转）的隐式写入程序。

### 创建您自己的记录程序和作者{#creating-your-own-loggers-and-writers}
...
1. 创建工厂配置[Apache Sling日志记录写入程序配置](/help/sites-deploying/osgi-configuration-settings.md)的新实例。
