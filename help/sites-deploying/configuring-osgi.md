...
title: 配置OSGi
seo-title: 配置OSGi
description: OSGi是Adobe Experience Manager(AEM)技术堆栈中的一个基本要素。 它用于控制AEM的复合束及其配置。 本文详细介绍了如何管理此类包的配置设置。
seo-description: OSGi是Adobe Experience Manager(AEM)技术堆栈中的一个基本要素。 它用于控制AEM的复合束及其配置。 本文详细介绍了如何管理此类包的配置设置。
