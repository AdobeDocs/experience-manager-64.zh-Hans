...
* **存储库**
   ...
   有关 [更多详细信息](/help/sites-deploying/configuring-osgi.md#osgi-configuration-in-the-repository) ，请参 [阅存储库中的OSGi配置，尤其是向存储库添加新配置](/help/sites-deploying/configuring-osgi.md#adding-a-new-configuration-to-the-repository) 。
