...
在客户端，AEM可与所有现代浏览器(**Microsoft Edge**、 **Internet Explorer** 11、Chrome **51+、Firefox********** 47+、SafariSafari 8+)在桌面和操作系统上共同工作。 有关详 [细信息，请参阅](/help/sites-deploying/technical-requirements.md#supported-client-platforms) “支持的客户端平台”。
