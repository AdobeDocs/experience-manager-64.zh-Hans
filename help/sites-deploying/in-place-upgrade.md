...
>[!NOTE]
>
>本页概述了AEM 6.4的升级过程。如果已将安装部署到应用程序服务器，请参阅应用程 [序服务器安装的升级步骤](/help/sites-deploying/app-server-upgrade.md)。
...
要执行升级，请务必使用jar文件启动AEM以调出实例。 要升级到6.4，另请参阅“延迟内容迁移”中的其他内容重组和迁移选项 [](/help/sites-deploying/lazy-content-migration.md) ，您可以使用升级命令进行选择。
