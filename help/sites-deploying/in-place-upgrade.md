...
>[!NOTE]
>
>本页概述了AEM 6.4的升级过程。如果您有部署到应用程序服务器的安装，请参阅应用 [程序服务器安装的升级步骤](/help/sites-deploying/app-server-upgrade.md)。
...
要执行升级，开始AEM必须使用jar文件来调出实例。 要升级到6.4，另请参阅“延迟内容迁移”中的其他内容重 [组和迁移选项](/help/sites-deploying/lazy-content-migration.md) ，您可以使用升级命令进行选择。
