...
description: 详细描述升级到AEM 6.3时自动卸载的包的列表。
seo-description: 详细描述升级到AEM 6.3时自动卸载的包的列表。
...
>[!NOTE]
>
>如果您的代码依赖于这些包，请确保与Adobe支持部门联系并要求为受影响区域提供兼容包。
...
* org.apache.sling.installer.factory.subess，版本1.0.0，活动
