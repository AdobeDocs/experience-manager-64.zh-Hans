...
* 有关资产分载的一般准则和最佳实践，请参 [阅资产分载的一般准则和最佳实践](/help/assets/assets-offloading-best-practices.md#general-guidance-and-best-practices-for-asset-offloading)。
* 要了解如何禁用卸载代理的自动创建，请参阅关 [闭自动代理管理](/help/assets/assets-offloading-best-practices.md#turning-off-automatic-agent-management)。
