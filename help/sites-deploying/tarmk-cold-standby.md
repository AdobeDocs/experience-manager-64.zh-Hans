...
>
>这可以通过转到&#x200B;*http://localhost:4502/system/console/status-slingsettings*&#x200B;并检查&#x200B;**&quot;Run Modes&quot;**&#x200B;行来完成。
...
1. 在维护过程完成并重新启动实例之后：
   ...
   * 在待机状态下，数据存储垃圾收集只能通过&#x200B;**BlobGarbageCollection** MBean - `startBlobGC()`使用。 待机时不提供&#x200B;**RepositoryManagement** MBean。
