...
有关将UI模块添加到ContextHub的信息，请 [参阅添加UI模块](/help/sites-administering/contexthub-config.md#adding-a-ui-module)。 有关开发UI模块的信息，请参 [阅创建ContextHub UI模块类型](/help/sites-developing/ch-extend.md#creating-contexthub-ui-module-types)。
...
contexthub.browserinfo UI模块显示有关客户端Web浏览器和操作系统的信息。 根据contexthub.surferinfo存储候选，从surferinfo存储 [获取信息](/help/sites-developing/ch-samplestores.md#contexthub-surferinfo-sample-store-candidate) 。
