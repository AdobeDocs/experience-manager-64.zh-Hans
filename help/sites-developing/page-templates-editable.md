...
>[!NOTE]
>
>AEM 6.4.5.0或更高版本才能将可编辑的模板与 [SPA编辑器](/help/sites-developing/spa-overview.md).
...
1. **启用模板**
   ...
   * [启用模板](/help/sites-authoring/templates.md#enabling-and-allowing-a-template-template-author) 从 **模板** 控制台。
   * 在 `jcr:content` 节点。
...
* 模型 — OSGi包
   ...
   的 [OSGi包](/help/sites-deploying/osgi-configuration-settings.md) 实施功能。
