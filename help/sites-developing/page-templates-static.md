...
要为网站启用现有模板，并且希望在从“网站”控制台的“网站”下创建页面时，该模板显示在“创建页面 ************ ”对话框中，请将模板节点的allowedPaths属性设置为： **/content(/.&amp;ast;)?**
...
1. 将现有模板（最好将定义尽可能接近您想要达到的目标）复制到新节点。
   ...
   >[!NOTE]
   >
   >可用模板列表取决于新页面的位置以及在每个模板中指定的位置限制。 请参阅 [模板可用性](/help/sites-developing/templates.md#template-availability)。
