...
以下Java类实现 [PageInfoProvider](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/index.html) 和会返回当前页面资源的已发布URL。
