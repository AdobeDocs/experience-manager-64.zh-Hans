...
这两个实体与路由的概念有关，但只 [`ModelRouter`](/help/sites-developing/spa-routing.md) 负责使“PageModelManager [加载与当前应用程序状态同步的](/help/sites-developing/spa-blueprint.md#pagemodelmanager) 模型。
