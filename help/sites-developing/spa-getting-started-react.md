...
# SPA AEM快速入门——反应{#getting-started-with-spas-in-aem-react}
...
`Page`将采集页面模型的JSON表示形式，并处理内容以包装／装饰页面的每个元素。 有关`Page`的更多详细信息，请参阅文档[SPA Blueprint](/help/sites-developing/spa-blueprint.md)。
