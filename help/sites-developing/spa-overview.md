...
>[!NOTE]
>
>单页应用程序(SPA)编辑器功能需要 [AEM 6.4 Service Pack 2](/help/release-notes/sp-release-notes.md) 或更高版本。
>
...
AEM SPA Editor SDK是随AEM 6.4 Service Pack 2一起引入的。 Adobe完全支持它，并且作为一项新功能，它将继续得到增强和扩展。 SPA编辑器尚未涵盖以下AEM功能：
