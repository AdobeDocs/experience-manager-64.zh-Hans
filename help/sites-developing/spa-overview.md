...
>[!NOTE]
>
>单页应用程序(SPA)编辑器功能需 [要AEM 6.4 service pack 2或更高](/help/release-notes/sp-release-notes.md) 版本。
>
...
AEM 6.4 service pack 2引入了AEM SPA Editor SDK。 它得到Adobe的全面支持，并且作为一项新功能，它将继续得到增强和扩展。 SPA编辑器尚未涵盖以下AEM功能：
