...
1. 在发布服务器上或使用页面编辑器中的&#x200B;**页面信息**&#x200B;菜单中的选项&#x200B;**[!UICONTROL 查看已发布的]**&#x200B;加载We.Retail Journal应用程序。
...
1. 如果尚未加载，请在发布服务器上加载We.Retail Journal应用程序，或者使用页面编辑器中的&#x200B;**页面信息**&#x200B;菜单中的选项&#x200B;**[!UICONTROL 查看已发布]**&#x200B;来加载。
...
1. 在新选项卡中加载`react.model.json`。
   ...
   AEM SPA编辑器利用[AEM Content Services](/help/assets/content-fragments.md)以JSON模型形式交付页面的整个内容。
