...
艰难的第2天是一个应用程序，它允许您压力测试AEM实例的限制。 它可以随默认测试包一起开箱即用，也可以根据您的测试需求对其进行配置。 您可以观看 [这个录音](https://experienceleague.adobe.com/docs/experience-manager-gems-events/gems/gems2017/aem-toughday2-stress-testing-benchmarking-tool.html) 以呈现应用程序。
...
艰难的第2天当前报告了9个可评估的测试量度。 量度 **&amp;ast;** 符号仅在成功运行后才报告：
