...
>[!NOTE]
>
>对于使用默认端口本地安装的AEM创作实例，CRXDE Lite的URL为http://localhost:4502/crx/de/ [](http://localhost:4502/crx/de/)。

## 在CRXDE Lite中设置项目结构 {#setting-up-the-project-structure-in-crxde-lite}

使用CRXDE lite在存储库中创建mywebsite应用程序结构：

1. 在CRXDE Lite左侧的树中，右键单击文件夹，然后单 **`/apps`** 击创建 **[!UICONTROL >创建文件夹]**。 在“创 **建文件夹** ”对话框中，键入 `mywebsite` 作为文件夹名称，然后单击 **[!UICONTROL确定**。
1. 右键单击文件夹， `/apps/mywebsite` 然后单击“ **[!UICONTROL 创建”>“创建文件夹”]**。 在“创 **[!UICONTROL 建文件夹]** ”对话框中，键入 `components` 作为文件夹名称，然后单击“ **[!UICONTROL 确定”]**。
1. 右键单击文件夹， `/apps/mywebsite` 然后单击“ **[!UICONTROL 创建”>“创建文件夹”]**。 在“创 **[!UICONTROL 建文件夹]** ”对话框中，键入 `templates` 作为文件夹名称，然后单击“ **[!UICONTROL 确定”]**。
...
>[!NOTE]
>
>单击以下链接可下载 ``mywebsite.zip``。 该存档包含用于您设计的static.css和图像文件。
...
1. [使用WebDAV](/help/sites-administering/webdav-access.md) (访问http://localhost:4502)对URL的访问，将下载的mywebsite.zip文件中的示例文 `static.css` 件 `images` 和文件夹复制到文件夹中 `/etc/designs/mywebsite` 。
...
1. 在CRXDE Lite的文件夹树中，右键单击并单 `/apps/mywebsite/templates` 击创建 **[!UICONTROL >创建模板]**。

1. 在“创建模板”对话框中，键入以下值，然后单击“下 **[!UICONTROL 一步”]**:

   * **[!UICONTROL 标签]**:contentpage
   * **[!UICONTROL 标题]**:我的网站内容页面模板
   * **[!UICONTROL 说明]**:这是我的网站内容页面模板
...
1. 要指定可使用此模板的页面的路径，请单击加号按钮并在显示的 `/content(/.*)?` 文本框中键入内容。 然后，单击“下 **[!UICONTROL 一步]**”。
   ...
   允许的路径属性的值是正则 *表达式。* 路径与表达式匹配的页面可以使用模板。 在这种情况下，正则表达式将匹配文件夹的路径和 `/content` 所有子页面。

   创作者在下面创建页 `/content`面时， **** 内容页面模板会显示在可用模板列表中。

1. 在“允 **许的父项”和“允许的子项** ”面板中，单击 **[!UICONTROL [!UICONTROL Next]** ，然 **[!UICONTROL 后单击“确]******&#x200B;定”。 在CRXDE Lite中，单击“保 **[!UICONTROL 存全部”]**。
...
1. 在CRXDE Lite中，右键单击并单 `/apps/mywebsite/components` 击创建 **[!UICONTROL >组件]**。
1. 在创建 **[!UICONTROL 组件对话框中]** ，键入以下属性值：

   * **[!UICONTROL 标签]**:contentpage
   * **[!UICONTROL 标题]**:我的网站内容页面组件
   * **[!UICONTROL 说明]**:这是“我的网站内容”页面组件
...
1. 单 **[!UICONTROL 击“下一]** 步”，直到显 **[!UICONTROL 示对话框的“允许的子项]** ”面板，然后单击“ **[!UICONTROL 确定”]**。 在CRXDE Lite中，单击“保 **[!UICONTROL 存全部”]**。
...
1. 在文件夹树中，选择“网站”文 **[!UICONTROL 件夹]** ，然后单击“ **[!UICONTROL 新建”>“新建页面”]**。
1. 在“创 **[!UICONTROL 建页面]** ”窗口中，输入以下内容：
...
1. 在创建 **[!UICONTROL 页面对话框中]** ，输入以下属性值，然后单击创建：
...
1. 在创 **[!UICONTROL 建页面对话框]** ，输入以下属性值，然后单击创 **[!UICONTROL 建]**:
...
1. 要将页面链接到mywebsite设计，请在CRXDE Lite中选择该节 `/content/mywebsite/en/jcr:content` 点。 在“属 **[!UICONTROL 性]** ”选项卡上，为新属性键入以下值，然后单击“添加”:
...
1. 在新的Web浏览器选项卡或窗口中，打开 [http://localhost:4502/content/mywebsite/en/products.html](http://localhost:4502/content/mywebsite/en/products.html) ，查看产品页面：
...
1. 保存更改。
1. 在您的浏览器中，重新加载 **[!UICONTROL 产品页]** 。 它如下所示：
...
1. 在CRXDE Lite中，在以下位置创建 `left.jsp` 文件 `/apps/mywebsite/components/contentpage`:
   ...
   1. 右键单击节点，然 `/apps/mywebsite/components/contentpage`后选择创 **[!UICONTROL 建]** ，再 **[!UICONTROL 选择创建文件]**。
   1. 在窗口中，键 `left.jsp` 入为**名称**，然后单击“确 **[!UICONTROL 定”]**。
...
1. 在CRXDE Lite中，在以下位置创建 `center.jsp` 文件 `/apps/mywebsite/components/contentpage`:
   ...
   1. 右键单击该节点， `/apps/mywebsite/components/contentpage`选择创 **[!UICONTROL 建]**, **[!UICONTROL 然后选择创建文件]**。
   1. 在对话框中，键入 `center.jsp` Name **** ，然后单 **[!UICONTROL 击OK]**。
...
1. 在CRXDE Lite中，在以下位置创建 `right.jsp` 文件 `/apps/mywebsite/components/contentpage`:
   ...
   1. 右键单击该节点， `/apps/mywebsite/components/contentpage`选择创 **[!UICONTROL 建]**, **[!UICONTROL 然后选择创建文件]**。
   1. 在对话框中，键入为“名 `right.jsp` 称 **[!UICONTROL ”]** ，然后单 **[!UICONTROL 击“确定”]**。
...
1. 在CRXDE Lite中，右键单击， `/apps/mywebsite/components`选择创 **[!UICONTROL 建]**, **[!UICONTROL 然后创建组件]**。
1. 在创建 **[!UICONTROL 组件窗口]** ，输入以下内容：

   * **[!UICONTROL 标签]**: `topnav`
   * **[!UICONTROL 标题]**: `My Top Navigation Component`
   * **[!UICONTROL 描述]**: `This is My Top Navigation Component`

1. 单 **[!UICONTROL 击]** “下一步”，直到您进入单击“确定”的最后一个 **[!UICONTROL 窗口]**。 保存更改。
...
1. 保存更改。
1. 在您的浏览器中，重新加 **[!UICONTROL 载产品]** 页面。 顶部导航如下：

   ![chlimage_1-115](assets/chlimage_1-115.png)

#### 增强带有字幕的页面 {#enhancing-pages-with-subtitles}

页面 **** 组件定义了允许您为页面提供字幕的属性。 添加提供有关页面内容信息的字幕。

1. 在您的浏览器中，打开“产 **[!UICONTROL 品]** ”页面。
1. 在Sidekick页面选 **[!UICONTROL 项卡]** ，单击页 **[!UICONTROL 面属性]**。
1. 在对话框 **[!UICONTROL 的]** “基本”选项卡上，展开“更 **[!UICONTROL 多标题和说明”]** ，然后为“子标题”属 **[!UICONTROL 性键入]** “更多标题和说明” `what we do`。 单击&#x200B;**[!UICONTROL 确定]**。
1. 重复上述步骤，将有关我们服务 **的子标题添加** 到 **[!UICONTROL 服务页面]** 。
1. 重复上述步骤，将我们获得 **的信任的子标题添加** 到“客 **[!UICONTROL 户]** ”页面。
...
例如，指向“产品”页面的图像链接的源可以是http://localhost:4502/content/mywebsite/en/products.navimage.png。 Sling会解析此URL以确定资源类型和用于呈现资源的脚本：
...
1. 保存更改。
1. 右键单击该节点， `/apps/mywebsite/components/contentpage` 然后单击“ **[!UICONTROL 创建”>“创建文件”]**。
1. 在“创 **[!UICONTROL 建文件]** ”窗口中，键 **[!UICONTROL 入“名称]**” `navimage.png.java`。

   .java文件名扩展名向Sling表示应使用Apache Sling脚本Java支持编译脚本并创建servlet。

1. 将以下代码复制 `navimage.png.java.`到代码中扩展AbstractImageServlet类：

   * [AbstractImageServlet创建一个ImageContext对象，该对象存储当前资源的属性。](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/commons/AbstractImageServlet.html)
...
1. 保存更改。
1. 在您的浏览器中，重新加载 **[!UICONTROL 产品页]** 。 顶部导航现在显示如下：
...
创建位于产品页面下方的 **[!UICONTROL 两个页]** 面。 对于描述两个特定产品的每个页面，您都可以设置标题、说明和日期。

1. 在“网站”页面的文 **[!UICONTROL 件夹树中]** ，选择“网站／我的网站／英语／产品 **[!UICONTROL ”项目，然后单击“]** 新建”>“新建页面” ****。
...
1. 在对话框中输入以下属性值，然后单击“下 **[!UICONTROL 一步”]**:
   ...
   * **[!UICONTROL 标签]**:列表子项。
   * **[!UICONTROL 标题]**:我的列表子组件。
   * **[!UICONTROL 说明]**:这是我的列表子组件。

1. 继续单 **[!UICONTROL 击]** “下一步”，直到显 **[!UICONTROL 示“允许的子项]** ”面板，然后单击“ **[!UICONTROL 确定”]**。
...
1. 在列表子组件下创建对话框节点：
   ...
   1. 在CRXDE Lite中，右键单击该节点， `/apps/mywebsite/components/listchildren`然后单击“ **[!UICONTROL 创建”>“创建对话框”]**。
   1. 在对话框中，输入以下属性值，然后单击确定

      * **[!UICONTROL 标签]**: `dialog`
      * **[!UICONTROL 标题]**:并 `Edit Component` 单击“ **[!UICONTROL 确定”]**。
...
1. 在“属 **[!UICONTROL 性]** ”选项卡中，将title属性的值 **[!UICONTROL 更改为]**`List Children`
...
1. 使用以下属性值在项目节点下创建一个节点：
   ...
   * **[!UICONTROL 名称]**:listroot
   * **[!UICONTROL 类型]**:cq：构件
   ![screen_shot_2012-03-07at51031pm](assets/screen_shot_2012-03-07at51031pm.png)

1. 为列表节点添加属性，以将其配置为文本字段。 下表中的每行都表示一个属性。 完成后，单击“全 **[!UICONTROL 部保存”]**。
...
1. 在您的浏览器中，重新加载 **[!UICONTROL 产品页]** 。 列表子组件如下所示：
...
1. 在CRXDE Lite中，右键单击/apps/mywebsite/components，选择创建 **[!UICONTROL ，然后选择]**&#x200B;创建组件 ****。
...
1. 单击“下一步”，直到您到达对话框的最终面板，然后单击“确 **[!UICONTROL 定”]**。
...
1. 在标志组件下创建对话框节点：
   ...
   1. 右键单击该节点， `/apps/mywebsite/components/logo` 然后单击“ **[!UICONTROL 创建”>“创建对话框”]**。
...
1. 在该节 `design_dialog/items/items`点下，创建一个名为类型的 `img` 新节点 `cq:Widget`。 添加以下属性，然后单击“全 **[!UICONTROL 部保存”]**:
...
1. 打开文件，将以下代码复制到文件中，然后单击“全 **[!UICONTROL 部保存”]**:
...
1. 保存更改。
1. 在您的浏览器中，重新加载 **[!UICONTROL 产品页]** 。 徽标如下所示，但目前仅显示基础链接：
...
1. 在浏览器 **[!UICONTROL 中打开]** “产品”页面时，单击Sidekick底部的“设计 **[!UICONTROL ”按钮以进入“设]** 计 **** ”模式。

   ![](do-not-localize/chlimage_1-10.png)

1. 在标志栏的“设计”中，单 **[!UICONTROL 击]** “编辑”以使用对话框编辑标志组件的设置。
1. 在对话框中，单击“图像”选项卡的面 **[!UICONTROL 板]** ，浏览从文件提取的图像，然 `logo.png` 后单击“确 `mywebsite.zip` 定” ****。

   ![chlimage_1-124](assets/chlimage_1-124.png)

1. 单击Sidekick标题栏上的三角形以返回到“编 **[!UICONTROL 辑]** ”模式。
...
1. 保存更改。
1. 在您的浏览器中，重新加 **[!UICONTROL 载“产品1]** ”页。 跟踪组件如下所示：
...
1. 保存更改。
1. 在您的浏览器中，重新加载 **[!UICONTROL 产品页]** 。 标题组件如下所示：
...
1. 在您的浏览器中，刷新“产 **[!UICONTROL 品]** ”页面。 它现在具有parsys组件，如下所示：
...
1. 右键单击节 `/apps/mywebsite/components/logo` 点，然后单击 **[!UICONTROL 复制]**。
1. 右键单击该节 `/apps/mywebsite/components` 点，然后单击 **[!UICONTROL 粘贴]**。
1. 右键单击该节 `Copy of logo` 点，单击“重 **[!UICONTROL 命名]**”，删除现有文本和类型 `image`。
...
1. 在CRXDE Lite中，右键单击文件并选 `/libs/foundation/components/image/icon.png` 择复 **[!UICONTROL 制]**。
1. 右键单击节点，单 `/apps/mywebsite/components/image` 击粘贴 ****，然后单击 **[!UICONTROL 全部保存]**。

#### 使用图像组件 {#using-the-image-component}

在此部分中，您将查看产品页 **[!UICONTROL 面]** ，并将图像组件添加到段落系统。

1. 在您的浏览器中，重新加载 **[!UICONTROL 产品页]** 。
1. 在Sidekick中，单击“设计 **[!UICONTROL 模式”图标]** 。
1. 单击“ **[!UICONTROL 编辑]** ”按钮以编辑段落的设计对话框。
1. 对话框中显示了允许 **[!UICONTROL 的组件]** ;导览至 **[!UICONTROL MyWebsite]**，选择“我的图 **[!UICONTROL 像组件”]** ，然后单 **[!UICONTROL 击确定]**。
1. 返回“编 **[!UICONTROL 辑”模式]**。
1. 双击parsys框架(在 **[!UICONTROL将组件或资源拖动到此处**)。 “插 **[!UICONTROL 入新组件]** ”和 **** Sidekick选择器如下所示：
...
1. 在AEM网站页面的文件夹树中，选择，然 `Websites/My Website/English`后单击“ **[!UICONTROL 新建”>“新建页面”]**。 指定以下属性值，然后单击创建：

   * **[!UICONTROL 标题]**:工具栏
   * 选择 **[!UICONTROL 我的网站内容页面模板]**

1. 在页面列表中，右键单击工具栏页 **[!UICONTROL 面]** ，然后单击 **[!UICONTROL 属性]**。 选择“ **[!UICONTROL 在导航中隐藏]**”，然后单击“ **[!UICONTROL 确定”]**。

   “在导 **[!UICONTROL 航中隐藏]** ”选项可防止页面显示在导航组件中，如topnav和listchildren。

1. 在工 **[!UICONTROL 具栏下]**，创建以下页面：
...
1. 使用对话框配置组件：
   ...
   1. 在第一个面板中，指定以下属性值：
      ...
      * **[!UICONTROL 标签]**:搜索
      * **[!UICONTROL 标题]**:我的搜索组件
      * **[!UICONTROL 说明]**:这是我的搜索组件
      * **[!UICONTROL 组]**:我的网站
   1. 单击“ **[!UICONTROL 下一步]**”，然后再次 **[!UICONTROL 单击“下]** 一步”。
   1. 在“ **[!UICONTROL允许的父项** ”面板上，单击 **[!UICONTROL +按钮]** ，然后键入 `*/parsys`。
   1. 单击“ **[!UICONTROL 下一步]** ”，然后单 **[!UICONTROL 击“确定”]**。


1. 单击“ **[!UICONTROL 全部保存]**”。
1. 复制以下节点并将其粘贴到该节 `apps/mywebsite/components/search` 点：
...
1. 在您的浏览器中，重新加载 **[!UICONTROL 产品页]** 。 搜索组件如下所示：
...
1. 在您的浏览器中，打开“搜 **索** ”页面。
1. 在Sidekick中，单击“设计 **[!UICONTROL 模式]** ”图标。
1. 在段落设计（在搜索标题下）中，单击编 **[!UICONTROL 辑]**。
1. 在对话框中，向下滚动到“我的网 **[!UICONTROL 站”组]** ，选择“我的 **[!UICONTROL 搜索组件”]** ，然后单击“ **[!UICONTROL 确定”]**。
1. 在Sidekick上，单击三角形以返回到“编 **[!UICONTROL 辑]** ”模式。
1. 将“我 **[!UICONTROL 的搜索]** ”组件从Sidekick拖到parsys框架中。 它如下所示：

   ![chlimage_1-133](assets/chlimage_1-133.png)

1. 导航到您的 **[!UICONTROL 产品]** 页面。 在输入框中搜索客户，然后按 **[!UICONTROL Enter]**。 您将被重定向到“搜 **[!UICONTROL 索]** ”页面。 切换到“ **[!UICONTROL 预览]** ”模式：输出的格式与以下内容类似：
...
1. 保存更改。
1. 在您的浏览器中，重新加载 **[!UICONTROL 产品页]** 。 整个页面如下所示：
