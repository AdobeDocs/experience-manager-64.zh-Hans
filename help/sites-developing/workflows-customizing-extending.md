...
* [工作项目](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/workflow/exec/WorkItem.html) workItem
...
工作流元数据存储在 [`MetaDataMap`](#metadatamaps) 对象。 Java API提供 [`Workflow.getWorkflowData`](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/adobe/granite/workflow/exec/Workflow.html) 方法 [`WorkflowData`](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/adobe/granite/workflow/exec/WorkflowData.html) 提供相应 `MetaDataMap` 对象。 此 `WorkflowData` `MetaDataMap` 对象可用于步骤组件的OSGi服务或ECMA脚本。
...
1. 将以下属性应用到节点：
   ...
   * `cq:icon`
      ...
      用于指定 [Coral图标](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/coral-ui/coralui3/Coral.Icon.html) 中。
...
>
>AEM [现代化工具](/help/sites-developing/modernization-tools.md) 如果您要将经典UI步骤对话框升级为标准UI对话框。 在转换后，对于某些情况，仍可对对话框进行一些手动改进。
>
