...
>[!CAUTION]
>
>有关经典UI的使用，请参阅[AEM 6.3文档](https://helpx.adobe.com/experience-manager/6-3/sites-developing/workflows-models.html)以作参考。
...
1. 打开&#x200B;**[!UICONTROL 工作流模型]**&#x200B;控制台；通过&#x200B;**[!UICONTROL 工具]**、**[!UICONTROL 工作流]**、**[!UICONTROL 模型]**&#x200B;或，例如：

   [http://localhost:4502/aem/workflow](http://localhost:4502/aem/workflow)

1. 选择&#x200B;**[!UICONTROL 创建]**，然后选择&#x200B;**[!UICONTROL 创建模型]**。
1. 出现&#x200B;**[!UICONTROL 添加工作流模型]**&#x200B;对话框。 在选择&#x200B;**[!UICONTROL 完成]**&#x200B;之前，输入&#x200B;**[!UICONTROL 标题]**&#x200B;和&#x200B;**[!UICONTROL 名称]**（可选）。
1. 新模型列在&#x200B;**[!UICONTROL 工作流模型]**&#x200B;控制台中。
1. 选择新的工作流，然后使用[**[!UICONTROL Edit ]**打开它进行配置](#editing-a-workflow):
...
* 配置工作流属性，包括[stages](#configuring-workflow-stages-that-show-workflow-progress)、[工作流是否临时](#creating-a-transient-workflow)和／或[是否使用多个资源](#configuring-a-workflow-for-multi-resource-support)

编辑&#x200B;[**默认或旧**（现成）工作流](#editing-a-default-or-legacy-workflow-for-the-first-time)还有一个附加步骤，以确保在进行更改之前执行[安全副本](/help/sites-developing/workflows-best-practices.md#locations-workflow-models)。

完成对工作流的更新后，必须使用&#x200B;**[!UICONTROL Sync]**&#x200B;以&#x200B;**[!UICONTROL 生成运行时模型]**。 有关详细信息，请参阅[同步工作流](#sync-your-workflow-generate-a-runtime-model)。

### 同步工作流——生成运行时模型{#sync-your-workflow-generate-a-runtime-model}

**Sync** （在编辑器工具栏中）生成运行 [时模型](/help/sites-developing/workflows.md#runtime-model)。运行时模型是用户开始工作流时实际使用的模型。 如果您没有&#x200B;**[!UICONTROL 同步]**&#x200B;您的更改，则这些更改在运行时将不可用。

当您（或任何其他用户）对工作流进行任何更改时，您必须使用&#x200B;**[!UICONTROL Sync]**&#x200B;生成运行时模型——即使单个对话框（例如，步骤）具有自己的保存选项时也是如此。

当更改与运行时（已保存）模型同步时，将显示&#x200B;**[!UICONTROL 同步]**。

某些步骤包含必填字段和／或内置验证。 当这些条件不满足时，当您尝试&#x200B;**[!UICONTROL 同步]**&#x200B;模型时，将显示错误。 例如，当&#x200B;**[!UICONTROL 参与者]**&#x200B;步骤未定义任何参与者时：
...
编辑模型时，**[!UICONTROL 步骤]**&#x200B;浏览器的各组中会显示可用的步骤。 例如：
...
1. 打开&#x200B;**[!UICONTROL 步骤]**&#x200B;浏览器；使用顶部工具栏最左侧的&#x200B;**[!UICONTROL 切换侧面板]**。 在此对话框中，您可以：

   * **[!UICONTROL 过]** 滤器了解特定步骤。
   * 使用下拉选择器将选择限制为特定的步骤组。
...
1. 将相应的步骤拖动到模型中的所需位置。
   ...
   将其添加到流中后，您可以[配置步骤](#configuring-a-workflow-step)。
...
您可以使用&#x200B;**[!UICONTROL 步骤属性]**&#x200B;对话框&#x200B;**配置**&#x200B;和自定义工作流步骤的行为。

1. 要打开步骤的&#x200B;**[!UICONTROL 步骤属性]**&#x200B;对话框，请执行以下任一操作：

   * 点按工作流模型中的步骤，并从组件工具栏中选择&#x200B;**[!UICONTROL 配置]**。
   * 多次单击该步骤。
...
1. 根据需要配置&#x200B;**[!UICONTROL 步骤属性]**;可用的属性取决于步骤类型，也可能有多个可用的选项卡。 例如，新工作流中默认的&#x200B;**[!UICONTROL 参与者步骤]**&#x200B;为`Step 1`:
...
1. 使用&#x200B;**[!UICONTROL 保存并关闭]**&#x200B;确认更改；后跟&#x200B;**[!UICONTROL Sync]**（编辑器工具栏）以生成运行时模型。
...
>[!CAUTION]
>
>如果在&#x200B;**[!UICONTROL 页面属性]**&#x200B;中定义了工作流阶段，但不用于任何工作流步骤，则进度栏将不显示任何进度（无论当前工作流步骤如何）。

可用的阶段在工作流模型中定义；可以更新现有工作流模型以包含阶段定义。 您可以为工作流模型定义任意数量的阶段。

要为工作流定义&#x200B;**[!UICONTROL 阶段]**，请执行以下操作：
...
1. 使用[包管理器](/help/sites-administering/package-manager.md#package-manager)创建新包：
   ...
   1. 通过&#x200B;**[!UICONTROL 工具]**、**[!UICONTROL 部署]**、**[!UICONTROL 软件包]**&#x200B;导航到软件包管理器。
   1. 单击&#x200B;**[!UICONTROL 创建包]**。
   1. 根据需要指定&#x200B;**[!UICONTROL 包名称]**&#x200B;和任何其他详细信息。
   1. 单击&#x200B;**[!UICONTROL 确定]**。

1. 单击新包工具栏上的&#x200B;**[!UICONTROL 编辑]**。

1. 打开&#x200B;**[!UICONTROL 过滤器]**&#x200B;选项卡。

1. 选择&#x200B;**[!UICONTROL 添加筛选器]**&#x200B;并指定工作流模型&#x200B;*design*&#x200B;的路径：
...
1. 从包定义的工具栏中选择&#x200B;**[!UICONTROL 构建]**。
1. 从包工具栏中选择&#x200B;**[!UICONTROL 下载]**。
...
1. 创建新页面并打开它进行编辑。
1. 将&#x200B;**[!UICONTROL Form]**&#x200B;组件添加到页面。
1. 配置在页面中显示的&#x200B;**[!UICONTROL 表单开始]**&#x200B;组件。
1. 使用&#x200B;**[!UICONTROL 开始工作流]**&#x200B;从可用工作流中选择所需的工作流：
...
1. 定义&#x200B;**[!UICONTROL 有效负荷]**&#x200B;并确认。

1. 根据需要执行操作，以便工作流继续进行。
1. 在工作流运行时监视日志文件。

您还可以配置AEM以在日志文件中显示&#x200B;**[!UICONTROL DEBUG]**&#x200B;消息。 有关详细信息，请参阅[日志](/help/sites-deploying/configure-logging.md)，当开发完成时，将&#x200B;**[!UICONTROL 日志级别]**&#x200B;设置回&#x200B;**[!UICONTROL 信息]**。
...
1. 从步骤浏览器的&#x200B;**[!UICONTROL 工作流]**&#x200B;选择中，将&#x200B;**[!UICONTROL 参与者步骤]**&#x200B;拖动到工作流上，并将它放在&#x200B;**[!UICONTROL 流开始]**&#x200B;和**[!UICONTROL 流结束*]*之间。
1. 要打开属性对话框，请执行以下操作之一：

   * 单击参加者步骤，并从组件工具栏中选择&#x200B;**[!UICONTROL 配置]**。
   * 多次单击参加者步骤。

1. 在&#x200B;**[!UICONTROL Common]**&#x200B;选项卡中，输入`Validate Content`作为&#x200B;**[!UICONTROL Title]**&#x200B;和&#x200B;**[!UICONTROL Description]**。
...
1. 将&#x200B;**[!UICONTROL Or Split]**&#x200B;拖到工作流上，并将它放在`Validate Content`和&#x200B;**[!UICONTROL 流结束]**&#x200B;之间。
1. 打开&#x200B;**[!UICONTROL 或Split]**&#x200B;进行配置。
1. 配置:
...
1. 将此工作流应用于您的页面，当用户移动到&#x200B;**[!UICONTROL 完成]****[!UICONTROL 验证内容]**&#x200B;步骤时，他们可以选择是按请求&#x200B;]**发布页面，还是**[!UICONTROL &#x200B;拒绝发布请求&#x200B;]**。**[!UICONTROL 

   ![chlimage_1-182](assets/chlimage_1-182.png)

### 示例：定义OR拆分{#example-defining-a-rule-for-an-or-split}的规则
...
1. 编辑&#x200B;**[!UICONTROL OR Split]**&#x200B;的&#x200B;**[!UICONTROL 分支1]**&#x200B;的属性：

   * 通过将&#x200B;**[!UICONTROL Value]**&#x200B;设置为`true`，将其定义为&#x200B;**[!UICONTROL 默认路由]**。
   * 作为&#x200B;**[!UICONTROL 规则]**，设置脚本的路径。 例如：
...
1. 编辑&#x200B;**[!UICONTROL OR Split]**&#x200B;的&#x200B;**[!UICONTROL 分支2]**&#x200B;的属性。

   * 作为&#x200B;**[!UICONTROL 规则]**，将路径设置为其他脚本。 例如：

      `/apps/myapp/workflow/scripts/myscript2.ecma`

1. 设置每个分支中各个步骤的属性。 确保已设置&#x200B;**[!UICONTROL 用户／组]**。
...
例如，**[!UICONTROL 激活请求]**。 此工作流用于发布&#x200B;**[!UICONTROL Sites]**&#x200B;中的页面，并在内容作者没有适当的复制权限时自动触发。 有关更多详细信息，请参阅[自定义页面创作——自定义激活工作流请求](/help/sites-developing/customizing-page-authoring-touch.md#customizing-the-request-for-activation-workflow)。
