...
* box
   ...
   使用宽度和高 [度](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Component) ，将大小调整为框的任何组件的基类。
...
* 浏览对话框
   ...
   通过BrowseDialog，用户可以浏览存储库以选择路径。 它通常通过 [BrowseField使用](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.BrowseField)。
...
* 浏览器字段
   ...
   **已弃用：请改[用CQ.form.PathField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.PathField)**
...
* bulkeditor
   ...
   必须在HTML表单中插入BulkEditor（导入功能需要）。 这与 [CQ.Dialog完美结合](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Dialog)。
...
* 复选框组
   ...
   用于 [CQ.Ext.form.Checkbox控件的分组容器](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.Checkbox) 。
...
* 色场
   ...
   ColorField允许用户直接或使用 [CQ.Ext.ColorMenu输入颜色十六进制值](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.ColorMenu)。
...
* 颜色菜单
   ...
   包含 [CQ.Ext.ColorPalette组件的菜单](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.ColorPalette) 。
...
* 容器
   ...
   任何可能包 [含其他组件的CQ.Ext.BoxComponent](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.BoxComponent) 的基类。 容器处理包含项的基本行为，即添加、插入和删除项。
...
* contentfindertab
   ...
   [CQ.wcm.ContentFinder选项卡](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.ContentFinderTab)

   ContentFinderTab是一个专用面板，提供 [CQ.wcm.ContentFinder的选项卡面板中使用的功能](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.ContentFinder)。 通常，它有一个搜索表单（查询框）和一个用于显示搜索的数据视图。
...
* cq.workflow.model.combo
   ...
   WorkflowModelCombo是一个自定 [义的CQ.Ext.form.ComboBox](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.ComboBox) ，其中显示了可用工作流模型的列表。
...
* customcontentpanel
   ...
   CustomContentPanel是一种特殊的面板，用于 [CQ.Dialog](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Dialog):其内容从中检索并提交到与对话框中其他字段不同的URL。
...
* datefield
   ...
   提供带有 [CQ.Ext.DatePicker下拉菜单和自动日期验证的日期输入字段](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.DatePicker) 。
...
* datemenu
   ...
   包含 [CQ.Ext.DatePicker组件的菜单](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.DatePicker) 。
...
* dialofieldset
   ...
   DialogFieldSet是用于对 [话框的](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.FieldSet) FieldSet [](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Dialog)。
...
* 编辑栏
   ...
   尽管此处未列出，但EditBar具有 [CQ.wcm.EditBase的所有成员](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.EditBase)。
...
* 字段集
   ...
   用于对表单中的项目进行分组的标准 [容器](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.FormPanel)。...
...
* 分组存储
   ...
   提供按可用字段之一分组记录的专用存储实现。 这通常与 [CQ.Ext.grid.GroupingView一起使用](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.GroupingView) ，用于证明分组的GridPanel的数据模型。
...
* htmleditor
   ...
   编辑器的工具栏按钮在buttonTips属性中定义了工 [具提示](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.HtmlEditor) 。
...
* 列表视图
   ...
   CQ.Ext.list.ListView是类似于网格的视图的快速轻 [量实现](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.GridPanel) 。
...
* lvcolumn
   ...
   该类封装要在 [ListView的初始化中使用的列配置数据](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.list.ListView)。
...
* mediabrowsedialog
   ...
   **已弃用：请改[用内容查找器](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.ContentFinder)，浏览媒体。**
...
* 菜单
   ...
   菜单对象。 这是可向其添加菜单项的容器。 当您希望基于其他组件(例如 [CQ.Ext.menu.DateMenu](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.menu.DateMenu) )的专用菜单时，菜单也可以用作基类。

   菜单可能包含菜 [单项](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.menu.Item)，也可能包含常规 [](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Component)组件。
...
* menuitem
   ...
   需要菜单相关功能（如子菜单）且不是静态显示项的所有菜单项的基类。 Item通过添加菜单特定的激活和 [单击处理扩展了CQ.Ext.menu.BaseItem的基本功能](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.menu.BaseItem) 。
...
* 面板
   ...
   面板通过从 [CQ.Ext.Container继承而具有](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Container)。
...
* 密码
   ...
   密码与 [CQ.Ext.form.TextField类似](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.TextField) ，但其值保持私有，允许用户输入敏感数据。
...
* pathfield
   ...
   PathField是为路径设计的输入字段，路径完成后将打开 [CQ.BrowseDialog](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.BrowseDialog) ，用于浏览服务器存储库。 它还可以浏览页面段落以生成高级链接。
...
* 进度
   ...
   在手动模式下，您负责根据需要从您自己的代码中显示、更新( [通过updateProgress](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.ProgressBar))和清除进度栏。 当您要显示进度时，此方法最合适。
...
* propertygrid
   ...
   专门实现的网格功能旨在模仿开发IDE中通常看到的传统属性网格。 网格中的每行都表示某个对象的属性，并且数据作为一组名称／值对存储在 [CQ.Ext.grid.](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.PropertyRecord)PropertyRecords中。
...
* 快速提示
   ...
   @xtype quicktip在标记中指定并由全局 [CQ.Ext.QuickTips实例自动管理的工具提示专用工具提示类](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.QuickTips) 。 有关其他使用详细信息和示例，请参阅QuickTips类标题。
...
* 放射组
   ...
   用于 [CQ.Ext.form.Radio控件的分组容器](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.Radio) 。
...
* 滚动计划
   ...
   RolloutPlan提供一个用于观察页面转出进度的对话框。 RolloutPlan由 [CQ.wcm.msm.RolloutWizard启动](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.msm.RolloutWizard)。
...
* 滚水板
   ...
   RolloutWizard提供了用于滚出页面的向导。 RolloutWizard启 [动CQ.wcm.msm.RolloutPlan](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.msm.RolloutPlan)。
...
* 幻灯片放映
   ...
   幻灯片放映组件基于 [CQ.form.SmartImage组件](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.SmartImage) 。
...
* 建议字段
   ...
   [CQ.form.SuckestField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.SuggestField)
...
* 表编辑
   ...
   **已弃用：请[改用CQ.form.TableEdit2](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.TableEdit2)。**
...
* text按钮
   ...
   TextButton提供了一个具有 [CQ.Ext.Button功能的文本链接](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Button)。
...
* 触发器
   ...
   为TextFields提供便捷的包装器，它添加了可单击的触发器按钮（默认情况下类似于组合框）。 触发器没有默认操作，因此您必须指定一个函数以通过覆盖 [onTriggerClick来实现触发器单击处](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.TriggerField)理函数。 您可以直接创建TriggerField，因为它呈现的就像一个组合框一样。
